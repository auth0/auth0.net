...
public class AuthenticationTestsFixture : TestBaseFixture
{
    ...
    public CreateUserResponseContent TestPlusUser;
    public CreateUserResponseContent TestUserInDefaultDirectory;
    ...
    public override async Task InitializeAsync()
    {
        ...
        TestUser = await ApiClient.Users.CreateAsync(new CreateUserRequestContent
        {
        ...
        TestPlusUser = await ApiClient.Users.CreateAsync(new CreateUserRequestContent
        {
            Connection = TestConnection.Name,
        ...
        // Add a user with a + in the username
        TestUserInDefaultDirectory = await ApiClient.Users.CreateAsync(new CreateUserRequestContent
        {
