...
~~~csharp
 var client = new ManagementApiClient("your token", new Uri("https://YOUR_ACCOUNT.auth0.com/api/v2"));
~~~
...
```
var client = new AuthenticationApiClient(new Uri("https://YOUR_ACCOUNT.auth0.com"));
```
