...
public partial class SecretsClient : ISecretsClient
{
    ...
    private async Task<WithRawResponse<Dictionary<string, string>>> GetAsyncCore(
        string id,
    ...
    private async Task<RawResponse> UpdateAsyncCore(
        string id,
        Dictionary<string, string> request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    ...
    /// </code></example>
    public WithRawResponseTask<Dictionary<string, string>> GetAsync(
        string id,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    ...
    {
        return new WithRawResponseTask(UpdateAsyncCore(id, request, options, cancellationToken));
    }
}
