...
public partial class ExecutionsClient : IExecutionsClient
{
    ...
    private async Task<WithRawResponse<GetActionExecutionResponseContent>> GetAsyncCore(
        string id,
    ...
    /// </code></example>
    public WithRawResponseTask<GetActionExecutionResponseContent> GetAsync(
        string id,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<GetActionExecutionResponseContent>(
