...
public partial class TemplatesClient : ITemplatesClient
{
    ...
    {
        return new WithRawResponseTask<ListVerifiableCredentialTemplatesPaginatedResponseContent>(
            ListInternalAsyncCore(request, options, cancellationToken)
        );
    }

    private async Task<
        WithRawResponse<ListVerifiableCredentialTemplatesPaginatedResponseContent>
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<ListVerifiableCredentialTemplatesPaginatedResponseContent>(
                        responseBody
                    )!;
                return new WithRawResponse<ListVerifiableCredentialTemplatesPaginatedResponseContent>()
                {
                    Data = responseData,
    ...
    private async Task<
        WithRawResponse<CreateVerifiableCredentialTemplateResponseContent>
    > CreateAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<CreateVerifiableCredentialTemplateResponseContent>(
                        responseBody
                    )!;
                return new WithRawResponse<CreateVerifiableCredentialTemplateResponseContent>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<GetVerifiableCredentialTemplateResponseContent>
    > GetAsyncCore(
        string id,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        var response = await _client
            .SendRequestAsync(
                new JsonRequest
                {
                    Method = HttpMethod.Get,
                    Path = string.Format(
                        "verifiable-credentials/verification/templates/{0}",
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<GetVerifiableCredentialTemplateResponseContent>(
                        responseBody
                    )!;
                return new WithRawResponse<GetVerifiableCredentialTemplateResponseContent>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<UpdateVerifiableCredentialTemplateResponseContent>
    > UpdateAsyncCore(
        string id,
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<UpdateVerifiableCredentialTemplateResponseContent>(
                        responseBody
                    )!;
                return new WithRawResponse<UpdateVerifiableCredentialTemplateResponseContent>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    /// );
    /// </code></example>
    public async Task<Pager<VerifiableCredentialTemplateResponse>> ListAsync(
        ListVerifiableCredentialTemplatesRequestParameters request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<CreateVerifiableCredentialTemplateResponseContent> CreateAsync(
        CreateVerifiableCredentialTemplateRequestContent request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<CreateVerifiableCredentialTemplateResponseContent>(
    ...
    /// </code></example>
    public WithRawResponseTask<GetVerifiableCredentialTemplateResponseContent> GetAsync(
        string id,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<GetVerifiableCredentialTemplateResponseContent>(
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<UpdateVerifiableCredentialTemplateResponseContent> UpdateAsync(
        string id,
        UpdateVerifiableCredentialTemplateRequestContent request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    ...
    {
        return new WithRawResponseTask<UpdateVerifiableCredentialTemplateResponseContent>(
