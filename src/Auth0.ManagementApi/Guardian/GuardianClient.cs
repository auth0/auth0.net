...
public partial class GuardianClient : IGuardianClient
{
    ...
    {
        _client = client;
        Enrollments = new Auth0.ManagementApi.Guardian.EnrollmentsClient(_client);
    ...
    private async Task<WithRawResponse<GetGuardianSettingsResponseContent>> GetAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<GetGuardianSettingsResponseContent>(
                    responseBody
                )!;
                return new WithRawResponse<GetGuardianSettingsResponseContent>()
                {
                    Data = responseData,
    ...
    private async Task<WithRawResponse<SetGuardianSettingsResponseContent>> SetAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<SetGuardianSettingsResponseContent>(
                    responseBody
                )!;
                return new WithRawResponse<SetGuardianSettingsResponseContent>()
                {
                    Data = responseData,
                    RawResponse = new Auth0.ManagementApi.RawResponse()
                    {
    ...
    /// </code></example>
    public WithRawResponseTask<GetGuardianSettingsResponseContent> GetAsync(
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<GetGuardianSettingsResponseContent>(
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<SetGuardianSettingsResponseContent> SetAsync(
        SetGuardianSettingsRequestContent request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<SetGuardianSettingsResponseContent>(
