...
public partial class BlocksClient : IBlocksClient
{
    ...
    private async Task<RawResponse> CheckIpAsyncCore(
        string id,
    ...
    private async Task<RawResponse> UnblockIpAsyncCore(
        string id,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    ...
    /// </code></example>
    public WithRawResponseTask CheckIpAsync(
        string id,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask(CheckIpAsyncCore(id, options, cancellationToken));
    }
    ...
    /// </code></example>
    public WithRawResponseTask UnblockIpAsync(
        string id,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask(UnblockIpAsyncCore(id, options, cancellationToken));
    }
}
