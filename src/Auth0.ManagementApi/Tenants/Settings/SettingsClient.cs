...
public partial class SettingsClient : ISettingsClient
{
    ...
    private async Task<WithRawResponse<GetTenantSettingsResponseContent>> GetAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                ...
                return new WithRawResponse<GetTenantSettingsResponseContent>()
                {
                    Data = responseData,
    ...
    private async Task<WithRawResponse<UpdateTenantSettingsResponseContent>> UpdateAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                ...
                return new WithRawResponse<UpdateTenantSettingsResponseContent>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<GetTenantSettingsResponseContent> GetAsync(
        GetTenantSettingsRequestParameters request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<GetTenantSettingsResponseContent>(
    ...
    /// </code></example>
    public WithRawResponseTask<UpdateTenantSettingsResponseContent> UpdateAsync(
        UpdateTenantSettingsRequestContent request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<UpdateTenantSettingsResponseContent>(
