...
public partial class PartialsClient : IPartialsClient
{
    private readonly RawClient _client;

    internal PartialsClient(RawClient client)
    {
        _client = client;
    }
    ...
    )
    {
        return new WithRawResponseTask<Dictionary<string, object?>>(
            GetAsyncCore(prompt, options, cancellationToken)
        );
    }
    ...
    {
        return new WithRawResponseTask(SetAsyncCore(prompt, request, options, cancellationToken));
    }
}
