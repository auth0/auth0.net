...
public partial class MultifactorClient : IMultifactorClient
{
    private readonly RawClient _client;

    internal MultifactorClient(RawClient client)
    {
        _client = client;
    }

    private async Task<RawResponse> InvalidateRememberBrowserAsyncCore(
        string id,
    ...
    private async Task<RawResponse> DeleteProviderAsyncCore(
        string id,
    ...
    /// </code></example>
    public WithRawResponseTask InvalidateRememberBrowserAsync(
        string id,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask(
            InvalidateRememberBrowserAsyncCore(id, options, cancellationToken)
        );
    }
    ...
    /// </code></example>
    public WithRawResponseTask DeleteProviderAsync(
        string id,
        UserMultifactorProviderEnum provider,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    ...
    {
        return new WithRawResponseTask(
            DeleteProviderAsyncCore(id, provider, options, cancellationToken)
        );
    }
}
