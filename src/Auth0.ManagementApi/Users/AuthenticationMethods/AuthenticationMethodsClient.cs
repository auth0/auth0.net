...
public partial class AuthenticationMethodsClient : IAuthenticationMethodsClient
{
    ...
    private async Task<RawResponse> DeleteAllAsyncCore(
        string id,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    ...
    /// </code></example>
    public WithRawResponseTask DeleteAllAsync(
        string id,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask(DeleteAllAsyncCore(id, options, cancellationToken));
    }
    ...
    )
    {
        return new WithRawResponseTask(
            DeleteAsyncCore(id, authenticationMethodId, options, cancellationToken)
        );
    }
