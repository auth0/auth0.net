...
public partial class RiskAssessmentsClient : IRiskAssessmentsClient
{
    ...
    private async Task<RawResponse> ClearAsyncCore(
        string id,
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask ClearAsync(
        string id,
        ClearAssessorsRequestContent request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    ...
    {
        return new WithRawResponseTask(ClearAsyncCore(id, request, options, cancellationToken));
    }
}
