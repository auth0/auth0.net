...
public partial class FederatedConnectionsTokensetsClient : IFederatedConnectionsTokensetsClient
{
    ...
    private async Task<WithRawResponse<IEnumerable<FederatedConnectionTokenSet>>> ListAsyncCore(
        string id,
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                ...
                return new WithRawResponse<IEnumerable<FederatedConnectionTokenSet>>()
                {
                    Data = responseData,
            ...
            .SendRequestAsync(
                new JsonRequest
                {
                    ...
                    Path = string.Format(
                        ...
                        ValueConvert.ToPathParameterString(id),
                        ValueConvert.ToPathParameterString(tokensetId)
                    ),
                    QueryString = _queryString,
                    Headers = _headers,
                    Options = options,
    ...
    /// </code></example>
    public WithRawResponseTask<IEnumerable<FederatedConnectionTokenSet>> ListAsync(
        string id,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<IEnumerable<FederatedConnectionTokenSet>>(
    ...
    {
        return new WithRawResponseTask(DeleteAsyncCore(id, tokensetId, options, cancellationToken));
    }
}
