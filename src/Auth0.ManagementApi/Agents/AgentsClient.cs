...
public partial class AgentsClient : IAgentsClient
{
    ...
    /// Get agents
    /// </summary>
    private WithRawResponseTask<ListAgentsResponseContent> ListInternalAsync(
        ListAgentsRequestParameters request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<ListAgentsResponseContent>(
            ListInternalAsyncCore(request, options, cancellationToken)
        );
    }

    private async Task<WithRawResponse<ListAgentsResponseContent>> ListInternalAsyncCore(
        ListAgentsRequestParameters request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<ListAgentsResponseContent>(responseBody)!;
                return new WithRawResponse<ListAgentsResponseContent>()
                {
                    Data = responseData,
    ...
    private async Task<WithRawResponse<AgentResponseContent>> CreateAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<AgentResponseContent>(responseBody)!;
                return new WithRawResponse<AgentResponseContent>()
                {
                    Data = responseData,
                    RawResponse = new Auth0.ManagementApi.RawResponse()
                    {
    ...
    private async Task<WithRawResponse<AgentResponseContent>> ReadAsyncCore(
        string id,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    ...
    private async Task<WithRawResponse<AgentResponseContent>> UpdateAsyncCore(
        string id,
    ...
    /// </code></example>
    public async Task<Pager<AgentResponseContent>> ListAsync(
        ListAgentsRequestParameters request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    ...
    /// </code></example>
    public WithRawResponseTask<AgentResponseContent> CreateAsync(
        CreateAgentRequestContent request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<AgentResponseContent>(
    ...
    /// </code></example>
    public WithRawResponseTask<AgentResponseContent> ReadAsync(
        string id,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<AgentResponseContent>(
            ReadAsyncCore(id, options, cancellationToken)
        );
    }
    ...
    /// </code></example>
    public WithRawResponseTask<AgentResponseContent> UpdateAsync(
        string id,
        PatchAgentRequestParameters request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
