...
public partial class CustomDomainsClient : ICustomDomainsClient
{
    ...
    private async Task<WithRawResponse<IEnumerable<CustomDomain>>> ListAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                ...
                return new WithRawResponse<IEnumerable<CustomDomain>>()
                {
                    Data = responseData,
    ...
    private async Task<WithRawResponse<CreateCustomDomainResponseContent>> CreateAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                ...
                return new WithRawResponse<CreateCustomDomainResponseContent>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                ...
                return new WithRawResponse<GetCustomDomainResponseContent>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<WithRawResponse<UpdateCustomDomainResponseContent>> UpdateAsyncCore(
        string id,
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                ...
                return new WithRawResponse<UpdateCustomDomainResponseContent>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<WithRawResponse<TestCustomDomainResponseContent>> TestAsyncCore(
        string id,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                ...
                return new WithRawResponse<TestCustomDomainResponseContent>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<WithRawResponse<VerifyCustomDomainResponseContent>> VerifyAsyncCore(
        string id,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                ...
                return new WithRawResponse<VerifyCustomDomainResponseContent>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<IEnumerable<CustomDomain>> ListAsync(
        ListCustomDomainsRequestParameters request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<IEnumerable<CustomDomain>>(
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<CreateCustomDomainResponseContent> CreateAsync(
        CreateCustomDomainRequestContent request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    ...
    /// </code></example>
    public WithRawResponseTask<GetCustomDomainResponseContent> GetAsync(
        string id,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<GetCustomDomainResponseContent>(
    ...
    /// </code></example>
    public WithRawResponseTask<UpdateCustomDomainResponseContent> UpdateAsync(
        string id,
        UpdateCustomDomainRequestContent request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    ...
    {
        return new WithRawResponseTask<UpdateCustomDomainResponseContent>(
    ...
    /// </code></example>
    public WithRawResponseTask<TestCustomDomainResponseContent> TestAsync(
        string id,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<TestCustomDomainResponseContent>(
    ...
    /// </code></example>
    public WithRawResponseTask<VerifyCustomDomainResponseContent> VerifyAsync(
        string id,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<VerifyCustomDomainResponseContent>(
            VerifyAsyncCore(id, options, cancellationToken)
        );
    }
}
