...
public partial class NetworkAclsClient : INetworkAclsClient
{
    ...
    /// </summary>
    private WithRawResponseTask<ListNetworkAclsOffsetPaginatedResponseContent> ListInternalAsync(
        ListNetworkAclsRequestParameters request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<ListNetworkAclsOffsetPaginatedResponseContent>(
            ListInternalAsyncCore(request, options, cancellationToken)
        );
    }

    private async Task<
        WithRawResponse<ListNetworkAclsOffsetPaginatedResponseContent>
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<ListNetworkAclsOffsetPaginatedResponseContent>(
                        responseBody
                    )!;
                return new WithRawResponse<ListNetworkAclsOffsetPaginatedResponseContent>()
                {
                    Data = responseData,
    ...
    private async Task<WithRawResponse<GetNetworkAclsResponseContent>> GetAsyncCore(
        string id,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<GetNetworkAclsResponseContent>(
                    responseBody
                )!;
                return new WithRawResponse<GetNetworkAclsResponseContent>()
                {
                    Data = responseData,
                    RawResponse = new Auth0.ManagementApi.RawResponse()
                    {
    ...
    private async Task<WithRawResponse<SetNetworkAclsResponseContent>> SetAsyncCore(
        string id,
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<SetNetworkAclsResponseContent>(
                    responseBody
                )!;
                return new WithRawResponse<SetNetworkAclsResponseContent>()
                {
                    Data = responseData,
                    RawResponse = new Auth0.ManagementApi.RawResponse()
                    {
    ...
    private async Task<WithRawResponse<UpdateNetworkAclResponseContent>> UpdateAsyncCore(
        string id,
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<UpdateNetworkAclResponseContent>(
                    responseBody
                )!;
                return new WithRawResponse<UpdateNetworkAclResponseContent>()
                {
                    Data = responseData,
                    RawResponse = new Auth0.ManagementApi.RawResponse()
                    {
    ...
    /// );
    /// </code></example>
    public async Task<Pager<NetworkAclsResponseContent>> ListAsync(
        ListNetworkAclsRequestParameters request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    ...
    {
        return new WithRawResponseTask(CreateAsyncCore(request, options, cancellationToken));
    }
    ...
    /// </code></example>
    public WithRawResponseTask<GetNetworkAclsResponseContent> GetAsync(
        string id,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<GetNetworkAclsResponseContent>(
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<SetNetworkAclsResponseContent> SetAsync(
        string id,
        SetNetworkAclRequestContent request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    ...
    {
        return new WithRawResponseTask<SetNetworkAclsResponseContent>(
    ...
    /// </code></example>
    public WithRawResponseTask<UpdateNetworkAclResponseContent> UpdateAsync(
        string id,
        UpdateNetworkAclRequestContent request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    ...
    {
        return new WithRawResponseTask<UpdateNetworkAclResponseContent>(
