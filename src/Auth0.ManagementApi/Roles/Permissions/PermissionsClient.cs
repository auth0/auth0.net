...
public partial class PermissionsClient : IPermissionsClient
{
    ...
    private async Task<RawResponse> AddAsyncCore(
        string id,
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask AddAsync(
        string id,
        AddRolePermissionsRequestContent request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    ...
    {
        return new WithRawResponseTask(AddAsyncCore(id, request, options, cancellationToken));
    }
