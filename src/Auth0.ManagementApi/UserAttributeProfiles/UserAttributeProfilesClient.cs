...
public partial class UserAttributeProfilesClient : IUserAttributeProfilesClient
{
    ...
    /// </summary>
    private WithRawResponseTask<ListUserAttributeProfilesPaginatedResponseContent> ListInternalAsync(
        ListUserAttributeProfileRequestParameters request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<ListUserAttributeProfilesPaginatedResponseContent>(
            ListInternalAsyncCore(request, options, cancellationToken)
        );
    }

    private async Task<
        WithRawResponse<ListUserAttributeProfilesPaginatedResponseContent>
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<ListUserAttributeProfilesPaginatedResponseContent>(
                        responseBody
                    )!;
                return new WithRawResponse<ListUserAttributeProfilesPaginatedResponseContent>()
                {
                    Data = responseData,
    ...
    private async Task<WithRawResponse<CreateUserAttributeProfileResponseContent>> CreateAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                ...
                return new WithRawResponse<CreateUserAttributeProfileResponseContent>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<ListUserAttributeProfileTemplateResponseContent>
    > ListTemplatesAsyncCore(
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<ListUserAttributeProfileTemplateResponseContent>(
                        responseBody
                    )!;
                return new WithRawResponse<ListUserAttributeProfileTemplateResponseContent>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<GetUserAttributeProfileTemplateResponseContent>
    > GetTemplateAsyncCore(
        string id,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<GetUserAttributeProfileTemplateResponseContent>(
                        responseBody
                    )!;
                return new WithRawResponse<GetUserAttributeProfileTemplateResponseContent>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<WithRawResponse<GetUserAttributeProfileResponseContent>> GetAsyncCore(
        string id,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                ...
                return new WithRawResponse<GetUserAttributeProfileResponseContent>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<WithRawResponse<UpdateUserAttributeProfileResponseContent>> UpdateAsyncCore(
        string id,
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                ...
                return new WithRawResponse<UpdateUserAttributeProfileResponseContent>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    /// );
    /// </code></example>
    public async Task<Pager<UserAttributeProfile>> ListAsync(
        ListUserAttributeProfileRequestParameters request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        >
            .CreateInstanceAsync(
                ...
                response => response.UserAttributeProfiles?.ToList(),
                cancellationToken
            )
            .ConfigureAwait(false);
        return pager;
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<CreateUserAttributeProfileResponseContent> CreateAsync(
        CreateUserAttributeProfileRequestContent request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<CreateUserAttributeProfileResponseContent>(
    ...
    /// </code></example>
    public WithRawResponseTask<ListUserAttributeProfileTemplateResponseContent> ListTemplatesAsync(
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<ListUserAttributeProfileTemplateResponseContent>(
            ListTemplatesAsyncCore(options, cancellationToken)
        );
    }
    ...
    /// </code></example>
    public WithRawResponseTask<GetUserAttributeProfileTemplateResponseContent> GetTemplateAsync(
        string id,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<GetUserAttributeProfileTemplateResponseContent>(
    ...
    /// </code></example>
    public WithRawResponseTask<GetUserAttributeProfileResponseContent> GetAsync(
        string id,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<GetUserAttributeProfileResponseContent>(
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<UpdateUserAttributeProfileResponseContent> UpdateAsync(
        string id,
        UpdateUserAttributeProfileRequestContent request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    ...
    {
        return new WithRawResponseTask<UpdateUserAttributeProfileResponseContent>(
