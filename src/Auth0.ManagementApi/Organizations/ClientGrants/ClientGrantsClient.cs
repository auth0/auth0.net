...
public partial class ClientGrantsClient : IClientGrantsClient
{
    ...
    private WithRawResponseTask<ListOrganizationClientGrantsOffsetPaginatedResponseContent> ListInternalAsync(
        string id,
    ...
    {
        return new WithRawResponseTask<ListOrganizationClientGrantsOffsetPaginatedResponseContent>(
            ListInternalAsyncCore(id, request, options, cancellationToken)
        );
    }

    private async Task<
        WithRawResponse<ListOrganizationClientGrantsOffsetPaginatedResponseContent>
    ...
    )
    {
        var _queryString = new Auth0.ManagementApi.Core.QueryStringBuilder.Builder(capacity: 6)
            ...
            .Add("grant_ids", request.GrantIds)
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<ListOrganizationClientGrantsOffsetPaginatedResponseContent>(
                        responseBody
                    )!;
                return new WithRawResponse<ListOrganizationClientGrantsOffsetPaginatedResponseContent>()
                {
                    Data = responseData,
    ...
    private async Task<
        WithRawResponse<AssociateOrganizationClientGrantResponseContent>
    > CreateAsyncCore(
        string id,
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<AssociateOrganizationClientGrantResponseContent>(
                        responseBody
                    )!;
                return new WithRawResponse<AssociateOrganizationClientGrantResponseContent>()
                {
                    Data = responseData,
                    RawResponse = new Auth0.ManagementApi.RawResponse()
                    {
    ...
    /// );
    /// </code></example>
    public async Task<Pager<OrganizationClientGrant>> ListAsync(
        string id,
        ListOrganizationClientGrantsRequestParameters request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<AssociateOrganizationClientGrantResponseContent> CreateAsync(
        string id,
        AssociateOrganizationClientGrantRequestContent request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    ...
    {
        return new WithRawResponseTask<AssociateOrganizationClientGrantResponseContent>(
    ...
    {
        return new WithRawResponseTask(DeleteAsyncCore(id, grantId, options, cancellationToken));
    }
}
