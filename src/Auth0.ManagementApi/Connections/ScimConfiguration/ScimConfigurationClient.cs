...
public partial class ScimConfigurationClient : IScimConfigurationClient
{
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                ...
                return new WithRawResponse<GetScimConfigurationResponseContent>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<WithRawResponse<CreateScimConfigurationResponseContent>> CreateAsyncCore(
        string id,
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                ...
                return new WithRawResponse<CreateScimConfigurationResponseContent>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<WithRawResponse<UpdateScimConfigurationResponseContent>> UpdateAsyncCore(
        string id,
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                ...
                return new WithRawResponse<UpdateScimConfigurationResponseContent>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<GetScimConfigurationDefaultMappingResponseContent>
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<GetScimConfigurationDefaultMappingResponseContent>(
                        responseBody
                    )!;
                return new WithRawResponse<GetScimConfigurationDefaultMappingResponseContent>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    /// );
    /// </code></example>
    public async Task<Pager<global::Auth0.ManagementApi.ScimConfiguration>> ListAsync(
        ListScimConfigurationsRequestParameters request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        var pager = await CursorPager<
            ...
            string?,
            global::Auth0.ManagementApi.ScimConfiguration
        >
            .CreateInstanceAsync(
                request,
                options,
    ...
    /// </code></example>
    public WithRawResponseTask<GetScimConfigurationResponseContent> GetAsync(
        string id,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<GetScimConfigurationResponseContent>(
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<CreateScimConfigurationResponseContent> CreateAsync(
        string id,
        Optional<CreateScimConfigurationRequestContent?> request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    ...
    {
        return new WithRawResponseTask<CreateScimConfigurationResponseContent>(
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<UpdateScimConfigurationResponseContent> UpdateAsync(
        string id,
        UpdateScimConfigurationRequestContent request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    ...
    {
        return new WithRawResponseTask<UpdateScimConfigurationResponseContent>(
    ...
    /// </code></example>
    public WithRawResponseTask<GetScimConfigurationDefaultMappingResponseContent> GetDefaultMappingAsync(
        string id,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<GetScimConfigurationDefaultMappingResponseContent>(
