...
public partial class TokensClient : ITokensClient
{
    ...
    private async Task<WithRawResponse<IEnumerable<ScimTokenItem>>> GetAsyncCore(
        string id,
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                ...
                return new WithRawResponse<IEnumerable<ScimTokenItem>>()
                {
                    Data = responseData,
    ...
    private async Task<WithRawResponse<CreateScimTokenResponseContent>> CreateAsyncCore(
        string id,
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                ...
                return new WithRawResponse<CreateScimTokenResponseContent>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    /// </code></example>
    public WithRawResponseTask<IEnumerable<ScimTokenItem>> GetAsync(
        string id,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<IEnumerable<ScimTokenItem>>(
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<CreateScimTokenResponseContent> CreateAsync(
        string id,
        CreateScimTokenRequestContent request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    ...
    {
        return new WithRawResponseTask<CreateScimTokenResponseContent>(
