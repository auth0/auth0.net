...
public partial class RefreshTokensClient : IRefreshTokensClient
{
    ...
    /// </summary>
    private WithRawResponseTask<GetRefreshTokensPaginatedResponseContent> ListInternalAsync(
        GetRefreshTokensRequestParameters request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<GetRefreshTokensPaginatedResponseContent>(
            ListInternalAsyncCore(request, options, cancellationToken)
        );
    }

    private async Task<
        WithRawResponse<GetRefreshTokensPaginatedResponseContent>
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<GetRefreshTokensPaginatedResponseContent>(
                    responseBody
                )!;
                return new WithRawResponse<GetRefreshTokensPaginatedResponseContent>()
                {
                    Data = responseData,
    ...
    private async Task<WithRawResponse<GetRefreshTokenResponseContent>> GetAsyncCore(
        string id,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                ...
                return new WithRawResponse<GetRefreshTokenResponseContent>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    private async Task<WithRawResponse<UpdateRefreshTokenResponseContent>> UpdateAsyncCore(
        string id,
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                ...
                return new WithRawResponse<UpdateRefreshTokenResponseContent>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    )
    {
        ...
        >
            .CreateInstanceAsync(
                ...
                response => response.RefreshTokens?.ToList(),
                cancellationToken
            )
            .ConfigureAwait(false);
        return pager;
    ...
    /// </code></example>
    public WithRawResponseTask<GetRefreshTokenResponseContent> GetAsync(
        string id,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<GetRefreshTokenResponseContent>(
    ...
    /// </code></example>
    public WithRawResponseTask<UpdateRefreshTokenResponseContent> UpdateAsync(
        string id,
        UpdateRefreshTokenRequestContent request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    ...
    {
        return new WithRawResponseTask<UpdateRefreshTokenResponseContent>(
