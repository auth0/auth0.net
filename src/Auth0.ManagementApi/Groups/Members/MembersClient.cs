...
public partial class MembersClient : IMembersClient
{
    ...
    /// </summary>
    private WithRawResponseTask<GetGroupMembersResponseContent> GetInternalAsync(
        string id,
    ...
    {
        return new WithRawResponseTask<GetGroupMembersResponseContent>(
            GetInternalAsyncCore(id, request, options, cancellationToken)
        );
    }

    private async Task<WithRawResponse<GetGroupMembersResponseContent>> GetInternalAsyncCore(
        string id,
        GetGroupMembersRequestParameters request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                ...
                return new WithRawResponse<GetGroupMembersResponseContent>()
                {
                    Data = responseData,
    ...
    /// );
    /// </code></example>
    public async Task<Pager<GroupMember>> GetAsync(
        string id,
        GetGroupMembersRequestParameters request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
