...
public partial class TemplatesClient : ITemplatesClient
{
    ...
    private async Task<RawResponse> UpdateUniversalLoginAsyncCore(
    ...
    private async Task<RawResponse> DeleteUniversalLoginAsyncCore(
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </code></example>
    public WithRawResponseTask UpdateUniversalLoginAsync(
        UpdateUniversalLoginTemplateRequestContent request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask(
            UpdateUniversalLoginAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// </code></example>
    public WithRawResponseTask DeleteUniversalLoginAsync(
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask(DeleteUniversalLoginAsyncCore(options, cancellationToken));
    }
}
