...
namespace Auth0.ManagementApi.Clients
{
    ...
    public class RolesClient : BaseClient
    {
        ...
        public Task<Role> CreateAsync(RoleCreateRequest request, CancellationToken token = default)
        {
            return Connection.SendAsync<Role>(HttpMethod.Post, BuildUri("roles"), request, DefaultHeaders, token: token);
        }
        ...
        {
            return Connection.SendAsync<object>(HttpMethod.Delete, BuildUri($"roles/{EncodePath(id)}"), null, DefaultHeaders, token: token);
        }
        ...
        public Task<IPagedList<Role>> GetAllAsync(GetRolesRequest request, CancellationToken token = default)
        {
            if (request == null)
        ...
        public Task<IPagedList<Role>> GetAllAsync(GetRolesRequest request, PaginationInfo pagination, CancellationToken token = default)
        {
            if (request == null)
                throw new ArgumentNullException(nameof(request));
            if (pagination == null)
        ...
        public Task<Role> GetAsync(string id, CancellationToken token = default)
        {
            return Connection.GetAsync<Role>(BuildUri($"roles/{EncodePath(id)}"), DefaultHeaders, token: token);
        }
        ...
        public Task<Role> UpdateAsync(string id, RoleUpdateRequest request, CancellationToken token = default)
        {
            return Connection.SendAsync<Role>(new HttpMethod("PATCH"), BuildUri($"roles/{EncodePath(id)}"), request, DefaultHeaders, token: token);
        }
        ...
        public Task<IPagedList<AssignedUser>> GetUsersAsync(string id, CancellationToken token = default)
        {
            return Connection.GetAsync<IPagedList<AssignedUser>>(BuildUri($"roles/{EncodePath(id)}/users"), DefaultHeaders, assignedUsersConverters, token);
        }
        ...
        /// <param name="token"></param>
        /// <returns>An <see cref="IPagedList{AssignedUser}"/> containing the assigned users.</returns>
        public Task<IPagedList<AssignedUser>> GetUsersAsync(string id, PaginationInfo pagination, CancellationToken token = default)
        {
            return Connection.GetAsync<IPagedList<AssignedUser>>(BuildUri($"roles/{EncodePath(id)}/users",
                new Dictionary<string, string>
                {
                    ...
                    {"per_page", pagination.PerPage.ToString()},
                    {"include_totals", pagination.IncludeTotals.ToString().ToLower()}
                }), DefaultHeaders, assignedUsersConverters, token);
        }
        ...
        /// <param name="token"></param>
        /// <returns>An <see cref="IPagedList{AssignedUser}"/> containing the assigned users.</returns>
        public Task<ICheckpointPagedList<AssignedUser>> GetUsersAsync(string id, CheckpointPaginationInfo pagination, CancellationToken token = default)
        {
            return Connection.GetAsync<ICheckpointPagedList<AssignedUser>>(BuildUri($"roles/{EncodePath(id)}/users",
                ...
                }), DefaultHeaders, assignedUsersCheckpointConverters, token);
        }
        ...
        public Task AssignUsersAsync(string id, AssignUsersRequest request, CancellationToken token = default)
        {
            return Connection.SendAsync<AssignUsersRequest>(HttpMethod.Post, BuildUri($"roles/{EncodePath(id)}/users"), request, DefaultHeaders, token: token);
        }
        ...
        public Task<IPagedList<Permission>> GetPermissionsAsync(string id, PaginationInfo pagination, CancellationToken token = default)
        {
        ...
        {
            return Connection.SendAsync<object>(HttpMethod.Post, BuildUri($"roles/{EncodePath(id)}/permissions"), request, DefaultHeaders, token: token);
        }
        ...
        {
            return Connection.SendAsync<object>(HttpMethod.Delete, BuildUri($"roles/{EncodePath(id)}/permissions"), request, DefaultHeaders, token: token);
        }
    }
}
