...
namespace Auth0.ManagementApi.Clients
{
    ...
    public class StatsClient : ClientBase
    {
        ...
        {
            var result = await Connection.RequestAsync<object>(HttpMethod.Get, "stats/active-users").ConfigureAwait(false);
        ...
        {
            return Connection.RequestAsync<IList<DailyStatistics>>(HttpMethod.Get, "stats/daily", queryStrings:
