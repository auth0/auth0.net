...
/// </summary>
[Serializable]
public record EventStreamCloudEventOrgConnectionAddedCloudEvent : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventOrgConnectionAddedCloudEventTypeEnum Type { get; set; }
    ...
    public required EventStreamCloudEventOrgConnectionAddedData Data { get; set; }
