...
/// </summary>
[Serializable]
public record CreateConnectionRequestContentLinkedin : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required CreateConnectionRequestContentLinkedinStrategy Strategy { get; set; }
