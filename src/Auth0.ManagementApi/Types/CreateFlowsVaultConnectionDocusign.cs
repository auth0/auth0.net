...
public class CreateFlowsVaultConnectionDocusign
{
    ...
    public void Visit(
        System.Action<Auth0.ManagementApi.CreateFlowsVaultConnectionDocusignOauthCode> onCreateFlowsVaultConnectionDocusignOauthCode,
        System.Action<Auth0.ManagementApi.CreateFlowsVaultConnectionDocusignUninitialized> onCreateFlowsVaultConnectionDocusignUninitialized
    )
    {
        switch (Type)
        {
