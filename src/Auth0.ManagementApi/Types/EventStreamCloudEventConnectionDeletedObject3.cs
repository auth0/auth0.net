...
[Serializable]
public record EventStreamCloudEventConnectionDeletedObject3 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionDeletedObject3Authentication? Authentication { get; set; }

    [Optional]
    [JsonPropertyName("connected_accounts")]
    public EventStreamCloudEventConnectionDeletedObject3ConnectedAccounts? ConnectedAccounts { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedObject3Metadata? Metadata { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedObject3Options? Options { get; set; }
    ...
    public required EventStreamCloudEventConnectionDeletedObject3StrategyEnum Strategy { get; set; }
