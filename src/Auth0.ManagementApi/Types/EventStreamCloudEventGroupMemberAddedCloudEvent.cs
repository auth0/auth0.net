...
/// </summary>
[Serializable]
public record EventStreamCloudEventGroupMemberAddedCloudEvent : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventGroupMemberAddedCloudEventTypeEnum Type { get; set; }
    ...
    public required EventStreamCloudEventGroupMemberAddedData Data { get; set; }
