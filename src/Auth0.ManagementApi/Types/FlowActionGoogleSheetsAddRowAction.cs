...
[JsonConverter(
    typeof(FlowActionGoogleSheetsAddRowAction.FlowActionGoogleSheetsAddRowActionSerializer)
)]
[Serializable]
public readonly record struct FlowActionGoogleSheetsAddRowAction : IStringEnum
{
    ...
    internal class FlowActionGoogleSheetsAddRowActionSerializer
        : JsonConverter<FlowActionGoogleSheetsAddRowAction>
    {
        public override FlowActionGoogleSheetsAddRowAction Read(
        ...
        )
        {
            ...
            return new FlowActionGoogleSheetsAddRowAction(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            FlowActionGoogleSheetsAddRowAction value,
            JsonSerializerOptions options
        )
        {
        ...
        public override FlowActionGoogleSheetsAddRowAction ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
