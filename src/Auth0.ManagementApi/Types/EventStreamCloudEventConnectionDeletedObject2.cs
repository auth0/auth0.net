...
[Serializable]
public record EventStreamCloudEventConnectionDeletedObject2 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionDeletedObject2Authentication? Authentication { get; set; }

    [Optional]
    [JsonPropertyName("connected_accounts")]
    public EventStreamCloudEventConnectionDeletedObject2ConnectedAccounts? ConnectedAccounts { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedObject2Metadata? Metadata { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedObject2Options? Options { get; set; }
    ...
    public required EventStreamCloudEventConnectionDeletedObject2StrategyEnum Strategy { get; set; }
