...
/// </summary>
[Serializable]
public record EventStreamCloudEventConnectionCreatedPreviousObject3Options : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionCreatedPreviousObject3OptionsAssertionDecryptionSettings? AssertionDecryptionSettings { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedPreviousObject3OptionsDigestAlgorithmEnum? DigestAlgorithm { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedPreviousObject3OptionsIdpinitiated? Idpinitiated { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedPreviousObject3OptionsProtocolBindingEnum? ProtocolBinding { get; set; }

    [Optional]
    [JsonPropertyName("set_user_root_attributes")]
    public EventStreamCloudEventConnectionCreatedPreviousObject3OptionsSetUserRootAttributesEnum? SetUserRootAttributes { get; set; }

    [Optional]
    [JsonPropertyName("signatureAlgorithm")]
    public EventStreamCloudEventConnectionCreatedPreviousObject3OptionsSignatureAlgorithmEnum? SignatureAlgorithm { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedPreviousObject3OptionsSubject? Subject { get; set; }
