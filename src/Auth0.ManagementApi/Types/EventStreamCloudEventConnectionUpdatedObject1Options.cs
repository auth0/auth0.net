...
/// </summary>
[Serializable]
public record EventStreamCloudEventConnectionUpdatedObject1Options : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionUpdatedObject1OptionsConnectionSettings? ConnectionSettings { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedObject1OptionsDpopSigningAlgEnum? DpopSigningAlg { get; set; }

    [Optional]
    [JsonPropertyName("federated_connections_access_tokens")]
    public EventStreamCloudEventConnectionUpdatedObject1OptionsFederatedConnectionsAccessTokens? FederatedConnectionsAccessTokens { get; set; }
    ...
    public IEnumerable<EventStreamCloudEventConnectionUpdatedObject1OptionsIdTokenSignedResponseAlgsItemEnum>? IdTokenSignedResponseAlgs { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedObject1OptionsOidcMetadata? OidcMetadata { get; set; }

    [Optional]
    [JsonPropertyName("schema_version")]
    public EventStreamCloudEventConnectionUpdatedObject1OptionsSchemaVersionEnum? SchemaVersion { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedObject1OptionsSetUserRootAttributesEnum? SetUserRootAttributes { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedObject1OptionsTokenEndpointAuthMethodEnum? TokenEndpointAuthMethod { get; set; }

    [Optional]
    [JsonPropertyName("token_endpoint_auth_signing_alg")]
    public EventStreamCloudEventConnectionUpdatedObject1OptionsTokenEndpointAuthSigningAlgEnum? TokenEndpointAuthSigningAlg { get; set; }

    [Optional]
    [JsonPropertyName("token_endpoint_jwtca_aud_format")]
    public EventStreamCloudEventConnectionUpdatedObject1OptionsTokenEndpointJwtcaAudFormatEnum? TokenEndpointJwtcaAudFormat { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedObject1OptionsAttributeMap? AttributeMap { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedObject1OptionsTypeEnum? Type { get; set; }
