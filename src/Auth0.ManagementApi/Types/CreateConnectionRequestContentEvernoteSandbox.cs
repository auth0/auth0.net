...
/// </summary>
[Serializable]
public record CreateConnectionRequestContentEvernoteSandbox : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required CreateConnectionRequestContentEvernoteSandboxStrategy Strategy { get; set; }
