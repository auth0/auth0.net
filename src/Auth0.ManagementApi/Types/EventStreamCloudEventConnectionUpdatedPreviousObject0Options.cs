...
/// </summary>
[Serializable]
public record EventStreamCloudEventConnectionUpdatedPreviousObject0Options : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject0OptionsConnectionSettings? ConnectionSettings { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject0OptionsDpopSigningAlgEnum? DpopSigningAlg { get; set; }

    [Optional]
    [JsonPropertyName("federated_connections_access_tokens")]
    public EventStreamCloudEventConnectionUpdatedPreviousObject0OptionsFederatedConnectionsAccessTokens? FederatedConnectionsAccessTokens { get; set; }
    ...
    public IEnumerable<EventStreamCloudEventConnectionUpdatedPreviousObject0OptionsIdTokenSignedResponseAlgsItemEnum>? IdTokenSignedResponseAlgs { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject0OptionsOidcMetadata? OidcMetadata { get; set; }

    [Optional]
    [JsonPropertyName("schema_version")]
    public EventStreamCloudEventConnectionUpdatedPreviousObject0OptionsSchemaVersionEnum? SchemaVersion { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject0OptionsSetUserRootAttributesEnum? SetUserRootAttributes { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject0OptionsTokenEndpointAuthMethodEnum? TokenEndpointAuthMethod { get; set; }

    [Optional]
    [JsonPropertyName("token_endpoint_auth_signing_alg")]
    public EventStreamCloudEventConnectionUpdatedPreviousObject0OptionsTokenEndpointAuthSigningAlgEnum? TokenEndpointAuthSigningAlg { get; set; }

    [Optional]
    [JsonPropertyName("token_endpoint_jwtca_aud_format")]
    public EventStreamCloudEventConnectionUpdatedPreviousObject0OptionsTokenEndpointJwtcaAudFormatEnum? TokenEndpointJwtcaAudFormat { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject0OptionsAttributeMap? AttributeMap { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject0OptionsTypeEnum? Type { get; set; }
