...
[JsonConverter(typeof(EventStreamResponseContent.JsonConverter))]
[Serializable]
public class EventStreamResponseContent
{
    private EventStreamResponseContent(string type, object? value)
    {
        Type = type;
        Value = value;
    }
    ...
    /// </summary>
    public static EventStreamResponseContent FromEventStreamWebhookResponseContent(
    ...
    /// </summary>
    public static EventStreamResponseContent FromEventStreamEventBridgeResponseContent(
    ...
    /// </summary>
    public static EventStreamResponseContent FromEventStreamActionResponseContent(
    ...
    public override bool Equals(object? obj)
    {
        ...
        if (ReferenceEquals(this, obj))
            return true;
        if (obj is not EventStreamResponseContent other)
            return false;
    ...
    public static implicit operator EventStreamResponseContent(
        Auth0.ManagementApi.EventStreamWebhookResponseContent value
    ) => new("eventStreamWebhookResponseContent", value);
    ...
    [Serializable]
    internal sealed class JsonConverter : JsonConverter<EventStreamResponseContent>
    {
        public override EventStreamResponseContent? Read(
        ...
        )
        {
            ...
            if (reader.TokenType == JsonTokenType.StartObject)
            {
                ...
                foreach (var (key, type) in types)
                {
                    try
                    {
                        ...
                        if (value != null)
                        {
                            EventStreamResponseContent result = new(key, value);
                            return result;
                        }
                    }
                    catch (JsonException)
            ...
            throw new JsonException(
                $"Cannot deserialize JSON token {reader.TokenType} into EventStreamResponseContent"
            );
        }

        public override void Write(
            Utf8JsonWriter writer,
            EventStreamResponseContent value,
            JsonSerializerOptions options
        )
        {
            if (value == null)
        ...
        public override EventStreamResponseContent ReadAsPropertyName(
            ref Utf8JsonReader reader,
            global::System.Type typeToConvert,
            JsonSerializerOptions options
        )
        {
            ...
            EventStreamResponseContent result = new("string", stringValue);
            return result;
        }
