...
[Serializable]
public record EventStreamCloudEventConnectionDeletedPreviousObject0 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject0Authentication? Authentication { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject0Metadata? Metadata { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject0ConnectedAccounts? ConnectedAccounts { get; set; }

    [Optional]
    [JsonPropertyName("options")]
    public EventStreamCloudEventConnectionDeletedPreviousObject0Options? Options { get; set; }
    ...
    public required EventStreamCloudEventConnectionDeletedPreviousObject0StrategyEnum Strategy { get; set; }
