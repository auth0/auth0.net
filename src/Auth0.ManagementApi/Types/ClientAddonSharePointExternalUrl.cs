...
/// </summary>
[JsonConverter(typeof(ClientAddonSharePointExternalUrl.JsonConverter))]
[Serializable]
public class ClientAddonSharePointExternalUrl
{
    private ClientAddonSharePointExternalUrl(string type, object? value)
    {
        Type = type;
        Value = value;
    }
    ...
    /// </summary>
    public static ClientAddonSharePointExternalUrl FromListOfString(IEnumerable<string> value) =>
        new("list", value);

    /// <summary>
    /// Factory method to create a union from a string value.
    /// </summary>
    public static ClientAddonSharePointExternalUrl FromString(string value) => new("string", value);
    ...
    public T Match<T>(Func<IEnumerable<string>, T> onListOfString, Func<string, T> onString)
    {
        return Type switch
        {
    ...
    public override bool Equals(object? obj)
    {
        ...
        if (ReferenceEquals(this, obj))
            return true;
        if (obj is not ClientAddonSharePointExternalUrl other)
            return false;
    ...
    public static implicit operator ClientAddonSharePointExternalUrl(string value) =>
        new("string", value);

    [Serializable]
    internal sealed class JsonConverter : JsonConverter<ClientAddonSharePointExternalUrl>
    {
        ...
        )
        {
            ...
            if (reader.TokenType == JsonTokenType.String)
            {
                ...
                ClientAddonSharePointExternalUrl stringResult = new("string", stringValue);
                return stringResult;
            }
            ...
            if (reader.TokenType == JsonTokenType.StartArray)
            {
                ...
                foreach (var (key, type) in types)
                {
                    try
                    {
                        ...
                        if (value != null)
                        {
                            ClientAddonSharePointExternalUrl result = new(key, value);
                            return result;
                        }
                    }
                    catch (JsonException)
            ...
            throw new JsonException(
                $"Cannot deserialize JSON token {reader.TokenType} into ClientAddonSharePointExternalUrl"
            );
        }

        public override void Write(
            Utf8JsonWriter writer,
            ClientAddonSharePointExternalUrl value,
            JsonSerializerOptions options
        )
        {
            if (value == null)
        ...
        {
            var stringValue = reader.GetString()!;
            ClientAddonSharePointExternalUrl result = new("string", stringValue);
            return result;
        }
