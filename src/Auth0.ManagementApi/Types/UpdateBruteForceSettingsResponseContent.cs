...
[Serializable]
public record UpdateBruteForceSettingsResponseContent : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public IEnumerable<UpdateBruteForceSettingsResponseContentShieldsItem>? Shields { get; set; }
    ...
    public UpdateBruteForceSettingsResponseContentMode? Mode { get; set; }
