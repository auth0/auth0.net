...
[Serializable]
public record EventStreamCloudEventConnectionUpdatedPreviousObject7 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject7Authentication? Authentication { get; set; }

    [Optional]
    [JsonPropertyName("connected_accounts")]
    public EventStreamCloudEventConnectionUpdatedPreviousObject7ConnectedAccounts? ConnectedAccounts { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject7Metadata? Metadata { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject7Options? Options { get; set; }
    ...
    public required EventStreamCloudEventConnectionUpdatedPreviousObject7StrategyEnum Strategy { get; set; }
