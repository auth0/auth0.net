...
/// </summary>
[Serializable]
public record CreateConnectionRequestContentSharepoint : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required CreateConnectionRequestContentSharepointStrategy Strategy { get; set; }
