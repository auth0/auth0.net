...
[Serializable]
public record EventStreamCloudEventConnectionDeletedObject1 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionDeletedObject1Authentication? Authentication { get; set; }

    [Optional]
    [JsonPropertyName("connected_accounts")]
    public EventStreamCloudEventConnectionDeletedObject1ConnectedAccounts? ConnectedAccounts { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedObject1Metadata? Metadata { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedObject1Options? Options { get; set; }
    ...
    public required EventStreamCloudEventConnectionDeletedObject1StrategyEnum Strategy { get; set; }
