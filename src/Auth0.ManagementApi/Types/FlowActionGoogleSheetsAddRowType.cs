...
[JsonConverter(typeof(FlowActionGoogleSheetsAddRowType.FlowActionGoogleSheetsAddRowTypeSerializer))]
[Serializable]
public readonly record struct FlowActionGoogleSheetsAddRowType : IStringEnum
{
    ...
    internal class FlowActionGoogleSheetsAddRowTypeSerializer
        : JsonConverter<FlowActionGoogleSheetsAddRowType>
    {
        public override FlowActionGoogleSheetsAddRowType Read(
        ...
        )
        {
            ...
            return new FlowActionGoogleSheetsAddRowType(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            FlowActionGoogleSheetsAddRowType value,
            JsonSerializerOptions options
        )
        {
        ...
        public override FlowActionGoogleSheetsAddRowType ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
