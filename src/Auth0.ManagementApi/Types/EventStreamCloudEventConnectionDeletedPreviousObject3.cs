...
[Serializable]
public record EventStreamCloudEventConnectionDeletedPreviousObject3 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject3Authentication? Authentication { get; set; }

    [Optional]
    [JsonPropertyName("connected_accounts")]
    public EventStreamCloudEventConnectionDeletedPreviousObject3ConnectedAccounts? ConnectedAccounts { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject3Metadata? Metadata { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject3Options? Options { get; set; }
    ...
    public required EventStreamCloudEventConnectionDeletedPreviousObject3StrategyEnum Strategy { get; set; }
