...
[JsonConverter(typeof(FlowActionHubspotEnrollContactParamsWorkflowId.JsonConverter))]
[Serializable]
public class FlowActionHubspotEnrollContactParamsWorkflowId
{
    private FlowActionHubspotEnrollContactParamsWorkflowId(string type, object? value)
    {
        Type = type;
        Value = value;
    }
    ...
    /// </summary>
    public static FlowActionHubspotEnrollContactParamsWorkflowId FromString(string value) =>
        new("string", value);

    /// <summary>
    /// Factory method to create a union from a int value.
    /// </summary>
    public static FlowActionHubspotEnrollContactParamsWorkflowId FromInt(int value) =>
        new("int", value);
    ...
    public override bool Equals(object? obj)
    {
        ...
        if (ReferenceEquals(this, obj))
            return true;
        if (obj is not FlowActionHubspotEnrollContactParamsWorkflowId other)
            return false;
    ...
    public static implicit operator FlowActionHubspotEnrollContactParamsWorkflowId(string value) =>
        new("string", value);

    public static implicit operator FlowActionHubspotEnrollContactParamsWorkflowId(int value) =>
        new("int", value);

    [Serializable]
    internal sealed class JsonConverter
        : JsonConverter<FlowActionHubspotEnrollContactParamsWorkflowId>
    {
        ...
        )
        {
            ...
            if (reader.TokenType == JsonTokenType.Number)
            {
                ...
                {
                    FlowActionHubspotEnrollContactParamsWorkflowId intResult = new("int", intValue);
                    return intResult;
                }
            }
            ...
            if (reader.TokenType == JsonTokenType.String)
            {
                ...
                {
                    FlowActionHubspotEnrollContactParamsWorkflowId intFromStringResult = new(
                        "int",
                        intFromStringValue
                    );
                ...
                FlowActionHubspotEnrollContactParamsWorkflowId stringResult = new(
                    "string",
                    stringValue
                );
                return stringResult;
            ...
            throw new JsonException(
                $"Cannot deserialize JSON token {reader.TokenType} into FlowActionHubspotEnrollContactParamsWorkflowId"
            );
        }

        public override void Write(
            Utf8JsonWriter writer,
            FlowActionHubspotEnrollContactParamsWorkflowId value,
            JsonSerializerOptions options
        )
        {
            if (value == null)
        ...
        {
            var stringValue = reader.GetString()!;
            FlowActionHubspotEnrollContactParamsWorkflowId result = new("string", stringValue);
            return result;
        }
