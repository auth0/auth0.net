...
[JsonConverter(
    typeof(CreateConnectionRequestContentWordpressStrategy.CreateConnectionRequestContentWordpressStrategySerializer)
)]
[Serializable]
public readonly record struct CreateConnectionRequestContentWordpressStrategy : IStringEnum
{
    ...
    internal class CreateConnectionRequestContentWordpressStrategySerializer
        : JsonConverter<CreateConnectionRequestContentWordpressStrategy>
    {
        public override CreateConnectionRequestContentWordpressStrategy Read(
        ...
        )
        {
            ...
            return new CreateConnectionRequestContentWordpressStrategy(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            CreateConnectionRequestContentWordpressStrategy value,
            JsonSerializerOptions options
        )
        {
        ...
        public override CreateConnectionRequestContentWordpressStrategy ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
