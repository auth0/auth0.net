...
/// </summary>
[Serializable]
public record EventStreamCloudEventOrgUpdatedPreviousObject : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventOrgUpdatedPreviousObjectBranding? Branding { get; set; }
