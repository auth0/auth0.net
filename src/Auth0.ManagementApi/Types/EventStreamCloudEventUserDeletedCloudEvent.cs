...
/// </summary>
[Serializable]
public record EventStreamCloudEventUserDeletedCloudEvent : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventUserDeletedCloudEventTypeEnum Type { get; set; }
    ...
    public required EventStreamCloudEventUserDeletedData Data { get; set; }
