...
/// </summary>
[Serializable]
public record EventStreamCloudEventOrgUpdatedCloudEvent : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventOrgUpdatedCloudEventTypeEnum Type { get; set; }
    ...
    public required EventStreamCloudEventOrgUpdatedData Data { get; set; }
