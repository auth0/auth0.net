...
/// </summary>
[Serializable]
public record EventStreamCloudEventUserDeletedPreviousObject
    : IJsonOnDeserialized,
        IJsonOnSerializing
{
    [JsonExtensionData]
    ...
    public IEnumerable<EventStreamCloudEventUserDeletedPreviousObjectIdentitiesItem> Identities { get; set; } =
        new List<EventStreamCloudEventUserDeletedPreviousObjectIdentitiesItem>();
