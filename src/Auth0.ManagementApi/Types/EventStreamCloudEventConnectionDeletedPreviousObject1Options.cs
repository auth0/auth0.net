...
/// </summary>
[Serializable]
public record EventStreamCloudEventConnectionDeletedPreviousObject1Options : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject1OptionsConnectionSettings? ConnectionSettings { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject1OptionsDpopSigningAlgEnum? DpopSigningAlg { get; set; }

    [Optional]
    [JsonPropertyName("federated_connections_access_tokens")]
    public EventStreamCloudEventConnectionDeletedPreviousObject1OptionsFederatedConnectionsAccessTokens? FederatedConnectionsAccessTokens { get; set; }
    ...
    public IEnumerable<EventStreamCloudEventConnectionDeletedPreviousObject1OptionsIdTokenSignedResponseAlgsItemEnum>? IdTokenSignedResponseAlgs { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject1OptionsOidcMetadata? OidcMetadata { get; set; }

    [Optional]
    [JsonPropertyName("schema_version")]
    public EventStreamCloudEventConnectionDeletedPreviousObject1OptionsSchemaVersionEnum? SchemaVersion { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject1OptionsSetUserRootAttributesEnum? SetUserRootAttributes { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject1OptionsTokenEndpointAuthMethodEnum? TokenEndpointAuthMethod { get; set; }

    [Optional]
    [JsonPropertyName("token_endpoint_auth_signing_alg")]
    public EventStreamCloudEventConnectionDeletedPreviousObject1OptionsTokenEndpointAuthSigningAlgEnum? TokenEndpointAuthSigningAlg { get; set; }

    [Optional]
    [JsonPropertyName("token_endpoint_jwtca_aud_format")]
    public EventStreamCloudEventConnectionDeletedPreviousObject1OptionsTokenEndpointJwtcaAudFormatEnum? TokenEndpointJwtcaAudFormat { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject1OptionsAttributeMap? AttributeMap { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject1OptionsTypeEnum? Type { get; set; }
