...
[Serializable]
public record EventStreamCloudEventConnectionUpdatedPreviousObject6 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject6Authentication? Authentication { get; set; }

    [Optional]
    [JsonPropertyName("connected_accounts")]
    public EventStreamCloudEventConnectionUpdatedPreviousObject6ConnectedAccounts? ConnectedAccounts { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject6Metadata? Metadata { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject6Options? Options { get; set; }
    ...
    public required EventStreamCloudEventConnectionUpdatedPreviousObject6StrategyEnum Strategy { get; set; }
