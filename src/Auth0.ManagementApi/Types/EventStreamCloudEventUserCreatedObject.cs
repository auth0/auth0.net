...
/// </summary>
[Serializable]
public record EventStreamCloudEventUserCreatedObject : IJsonOnDeserialized, IJsonOnSerializing
{
    [JsonExtensionData]
    ...
    public IEnumerable<EventStreamCloudEventUserCreatedObjectIdentitiesItem> Identities { get; set; } =
        new List<EventStreamCloudEventUserCreatedObjectIdentitiesItem>();
