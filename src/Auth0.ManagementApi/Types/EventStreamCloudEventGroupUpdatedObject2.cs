...
/// </summary>
[Serializable]
public record EventStreamCloudEventGroupUpdatedObject2 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventGroupUpdatedObject2TypeEnum Type { get; set; }
