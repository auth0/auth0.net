...
/// </summary>
[Serializable]
public record EventStreamCloudEventOrgMemberRoleDeleted : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventOrgMemberRoleDeletedCloudEvent Event { get; set; }
