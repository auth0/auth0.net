...
[Serializable]
public record EventStreamCloudEventConnectionCreatedPreviousObject4 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionCreatedPreviousObject4Authentication? Authentication { get; set; }

    [Optional]
    [JsonPropertyName("connected_accounts")]
    public EventStreamCloudEventConnectionCreatedPreviousObject4ConnectedAccounts? ConnectedAccounts { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedPreviousObject4Metadata? Metadata { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedPreviousObject4Options? Options { get; set; }
    ...
    public required EventStreamCloudEventConnectionCreatedPreviousObject4StrategyEnum Strategy { get; set; }
