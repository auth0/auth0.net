...
[Serializable]
public record EventStreamCloudEventConnectionUpdatedPreviousObject0 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject0Authentication? Authentication { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject0Metadata? Metadata { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject0ConnectedAccounts? ConnectedAccounts { get; set; }

    [Optional]
    [JsonPropertyName("options")]
    public EventStreamCloudEventConnectionUpdatedPreviousObject0Options? Options { get; set; }
    ...
    public required EventStreamCloudEventConnectionUpdatedPreviousObject0StrategyEnum Strategy { get; set; }
