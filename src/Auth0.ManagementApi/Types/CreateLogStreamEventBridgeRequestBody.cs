...
[Serializable]
public record CreateLogStreamEventBridgeRequestBody : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required LogStreamEventBridgeEnum Type { get; set; }
    ...
    public required LogStreamEventBridgeSink Sink { get; set; }
