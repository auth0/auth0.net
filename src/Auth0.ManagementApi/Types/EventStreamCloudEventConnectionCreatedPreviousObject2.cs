...
[Serializable]
public record EventStreamCloudEventConnectionCreatedPreviousObject2 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionCreatedPreviousObject2Authentication? Authentication { get; set; }

    [Optional]
    [JsonPropertyName("connected_accounts")]
    public EventStreamCloudEventConnectionCreatedPreviousObject2ConnectedAccounts? ConnectedAccounts { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedPreviousObject2Metadata? Metadata { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedPreviousObject2Options? Options { get; set; }
    ...
    public required EventStreamCloudEventConnectionCreatedPreviousObject2StrategyEnum Strategy { get; set; }
