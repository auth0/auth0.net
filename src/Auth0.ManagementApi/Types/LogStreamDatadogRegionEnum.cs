...
[JsonConverter(typeof(LogStreamDatadogRegionEnum.LogStreamDatadogRegionEnumSerializer))]
[Serializable]
public readonly record struct LogStreamDatadogRegionEnum : IStringEnum
{
    ...
    internal class LogStreamDatadogRegionEnumSerializer : JsonConverter<LogStreamDatadogRegionEnum>
    {
        public override LogStreamDatadogRegionEnum Read(
        ...
        )
        {
            ...
            return new LogStreamDatadogRegionEnum(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            LogStreamDatadogRegionEnum value,
            JsonSerializerOptions options
        )
        {
        ...
        public override LogStreamDatadogRegionEnum ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
