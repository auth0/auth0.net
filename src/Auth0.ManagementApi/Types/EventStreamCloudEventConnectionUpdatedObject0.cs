...
[Serializable]
public record EventStreamCloudEventConnectionUpdatedObject0 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionUpdatedObject0Authentication? Authentication { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedObject0Metadata? Metadata { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedObject0ConnectedAccounts? ConnectedAccounts { get; set; }

    [Optional]
    [JsonPropertyName("options")]
    public EventStreamCloudEventConnectionUpdatedObject0Options? Options { get; set; }
    ...
    public required EventStreamCloudEventConnectionUpdatedObject0StrategyEnum Strategy { get; set; }
