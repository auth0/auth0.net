...
[Serializable]
public record EventStreamCloudEventConnectionDeletedPreviousObject6 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject6Authentication? Authentication { get; set; }

    [Optional]
    [JsonPropertyName("connected_accounts")]
    public EventStreamCloudEventConnectionDeletedPreviousObject6ConnectedAccounts? ConnectedAccounts { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject6Metadata? Metadata { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject6Options? Options { get; set; }
    ...
    public required EventStreamCloudEventConnectionDeletedPreviousObject6StrategyEnum Strategy { get; set; }
