...
/// </summary>
[Serializable]
public record CreateConnectionRequestContentInstagram : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required CreateConnectionRequestContentInstagramStrategy Strategy { get; set; }
