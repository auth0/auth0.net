...
[Serializable]
public record EventStreamCloudEventConnectionDeletedPreviousObject4 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject4Authentication? Authentication { get; set; }

    [Optional]
    [JsonPropertyName("connected_accounts")]
    public EventStreamCloudEventConnectionDeletedPreviousObject4ConnectedAccounts? ConnectedAccounts { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject4Metadata? Metadata { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject4Options? Options { get; set; }
    ...
    public required EventStreamCloudEventConnectionDeletedPreviousObject4StrategyEnum Strategy { get; set; }
