...
[JsonConverter(
    typeof(FlowActionHttpSendRequestParamsMethod.FlowActionHttpSendRequestParamsMethodSerializer)
)]
[Serializable]
public readonly record struct FlowActionHttpSendRequestParamsMethod : IStringEnum
{
    ...
    internal class FlowActionHttpSendRequestParamsMethodSerializer
        : JsonConverter<FlowActionHttpSendRequestParamsMethod>
    {
        public override FlowActionHttpSendRequestParamsMethod Read(
