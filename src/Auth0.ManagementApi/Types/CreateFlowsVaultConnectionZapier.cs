...
public class CreateFlowsVaultConnectionZapier
{
    ...
    public void Visit(
        System.Action<Auth0.ManagementApi.CreateFlowsVaultConnectionZapierWebhook> onCreateFlowsVaultConnectionZapierWebhook,
        System.Action<Auth0.ManagementApi.CreateFlowsVaultConnectionZapierUninitialized> onCreateFlowsVaultConnectionZapierUninitialized
    )
    {
        switch (Type)
        {
