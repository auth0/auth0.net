...
/// </summary>
[Serializable]
public record EventStreamCloudEventConnectionCreated : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventConnectionCreatedCloudEvent Event { get; set; }
