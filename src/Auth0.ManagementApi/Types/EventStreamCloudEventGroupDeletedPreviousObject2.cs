...
/// </summary>
[Serializable]
public record EventStreamCloudEventGroupDeletedPreviousObject2 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventGroupDeletedPreviousObject2TypeEnum Type { get; set; }
