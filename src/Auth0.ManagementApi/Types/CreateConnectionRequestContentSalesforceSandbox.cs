...
/// </summary>
[Serializable]
public record CreateConnectionRequestContentSalesforceSandbox : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required CreateConnectionRequestContentSalesforceSandboxStrategy Strategy { get; set; }
