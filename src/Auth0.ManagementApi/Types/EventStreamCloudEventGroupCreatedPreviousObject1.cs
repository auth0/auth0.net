...
/// </summary>
[Serializable]
public record EventStreamCloudEventGroupCreatedPreviousObject1 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventGroupCreatedPreviousObject1TypeEnum Type { get; set; }
