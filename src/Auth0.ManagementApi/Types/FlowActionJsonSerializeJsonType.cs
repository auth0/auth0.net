...
[JsonConverter(typeof(FlowActionJsonSerializeJsonType.FlowActionJsonSerializeJsonTypeSerializer))]
[Serializable]
public readonly record struct FlowActionJsonSerializeJsonType : IStringEnum
{
    ...
    internal class FlowActionJsonSerializeJsonTypeSerializer
        : JsonConverter<FlowActionJsonSerializeJsonType>
    {
        public override FlowActionJsonSerializeJsonType Read(
        ...
        )
        {
            ...
            return new FlowActionJsonSerializeJsonType(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            FlowActionJsonSerializeJsonType value,
            JsonSerializerOptions options
        )
        {
        ...
        public override FlowActionJsonSerializeJsonType ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
