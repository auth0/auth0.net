...
[Serializable]
public record EventStreamCloudEventConnectionCreatedObject6 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionCreatedObject6Authentication? Authentication { get; set; }

    [Optional]
    [JsonPropertyName("connected_accounts")]
    public EventStreamCloudEventConnectionCreatedObject6ConnectedAccounts? ConnectedAccounts { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedObject6Metadata? Metadata { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedObject6Options? Options { get; set; }
    ...
    public required EventStreamCloudEventConnectionCreatedObject6StrategyEnum Strategy { get; set; }
