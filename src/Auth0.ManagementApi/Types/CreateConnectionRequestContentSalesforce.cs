...
/// </summary>
[Serializable]
public record CreateConnectionRequestContentSalesforce : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required CreateConnectionRequestContentSalesforceStrategy Strategy { get; set; }
