...
[Serializable]
public record EventStreamCloudEventConnectionDeletedPreviousObject5 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject5Authentication? Authentication { get; set; }

    [Optional]
    [JsonPropertyName("connected_accounts")]
    public EventStreamCloudEventConnectionDeletedPreviousObject5ConnectedAccounts? ConnectedAccounts { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject5Metadata? Metadata { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject5Options? Options { get; set; }

    [JsonPropertyName("strategy")]
    public required EventStreamCloudEventConnectionDeletedPreviousObject5StrategyEnum Strategy { get; set; }
