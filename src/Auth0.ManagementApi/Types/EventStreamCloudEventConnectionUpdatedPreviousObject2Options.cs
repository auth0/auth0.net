...
/// </summary>
[Serializable]
public record EventStreamCloudEventConnectionUpdatedPreviousObject2Options : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject2OptionsAssertionDecryptionSettings? AssertionDecryptionSettings { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject2OptionsDigestAlgorithmEnum? DigestAlgorithm { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject2OptionsIdpinitiated? Idpinitiated { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject2OptionsProtocolBindingEnum? ProtocolBinding { get; set; }

    [Optional]
    [JsonPropertyName("set_user_root_attributes")]
    public EventStreamCloudEventConnectionUpdatedPreviousObject2OptionsSetUserRootAttributesEnum? SetUserRootAttributes { get; set; }

    [Optional]
    [JsonPropertyName("signatureAlgorithm")]
    public EventStreamCloudEventConnectionUpdatedPreviousObject2OptionsSignatureAlgorithmEnum? SignatureAlgorithm { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject2OptionsSubject? Subject { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject2OptionsOidcMetadata? OidcMetadata { get; set; }
