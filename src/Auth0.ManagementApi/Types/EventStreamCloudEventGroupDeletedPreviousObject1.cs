...
/// </summary>
[Serializable]
public record EventStreamCloudEventGroupDeletedPreviousObject1 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventGroupDeletedPreviousObject1TypeEnum Type { get; set; }
