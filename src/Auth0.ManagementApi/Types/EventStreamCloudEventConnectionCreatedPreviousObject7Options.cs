...
/// </summary>
[Serializable]
public record EventStreamCloudEventConnectionCreatedPreviousObject7Options : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionCreatedPreviousObject7OptionsFederatedConnectionsAccessTokens? FederatedConnectionsAccessTokens { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedPreviousObject7OptionsIdentityApiEnum? IdentityApi { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedPreviousObject7OptionsSetUserRootAttributesEnum? SetUserRootAttributes { get; set; }

    [Optional]
    [JsonPropertyName("should_trust_email_verified_connection")]
    public EventStreamCloudEventConnectionCreatedPreviousObject7OptionsShouldTrustEmailVerifiedConnectionEnum? ShouldTrustEmailVerifiedConnection { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedPreviousObject7OptionsUseridAttributeEnum? UseridAttribute { get; set; }

    [Optional]
    [JsonPropertyName("waad_protocol")]
    public EventStreamCloudEventConnectionCreatedPreviousObject7OptionsWaadProtocolEnum? WaadProtocol { get; set; }
