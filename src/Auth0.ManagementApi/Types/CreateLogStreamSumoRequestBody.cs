...
[Serializable]
public record CreateLogStreamSumoRequestBody : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required LogStreamSumoEnum Type { get; set; }
    ...
    public required LogStreamSumoSink Sink { get; set; }
