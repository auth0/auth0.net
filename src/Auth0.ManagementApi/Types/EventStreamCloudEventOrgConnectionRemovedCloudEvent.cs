...
/// </summary>
[Serializable]
public record EventStreamCloudEventOrgConnectionRemovedCloudEvent : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventOrgConnectionRemovedCloudEventTypeEnum Type { get; set; }
    ...
    public required EventStreamCloudEventOrgConnectionRemovedData Data { get; set; }
