...
[Serializable]
public record EventStreamCloudEventConnectionCreatedPreviousObject3 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionCreatedPreviousObject3Authentication? Authentication { get; set; }

    [Optional]
    [JsonPropertyName("connected_accounts")]
    public EventStreamCloudEventConnectionCreatedPreviousObject3ConnectedAccounts? ConnectedAccounts { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedPreviousObject3Metadata? Metadata { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedPreviousObject3Options? Options { get; set; }
    ...
    public required EventStreamCloudEventConnectionCreatedPreviousObject3StrategyEnum Strategy { get; set; }
