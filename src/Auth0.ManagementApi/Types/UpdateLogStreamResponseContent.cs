...
[JsonConverter(typeof(UpdateLogStreamResponseContent.JsonConverter))]
[Serializable]
public class UpdateLogStreamResponseContent
{
    private UpdateLogStreamResponseContent(string type, object? value)
    {
        Type = type;
        Value = value;
    }
    ...
    /// </summary>
    public static UpdateLogStreamResponseContent FromLogStreamHttpResponseSchema(
    ...
    /// </summary>
    public static UpdateLogStreamResponseContent FromLogStreamEventBridgeResponseSchema(
    ...
    /// </summary>
    public static UpdateLogStreamResponseContent FromLogStreamEventGridResponseSchema(
    ...
    /// </summary>
    public static UpdateLogStreamResponseContent FromLogStreamDatadogResponseSchema(
    ...
    /// </summary>
    public static UpdateLogStreamResponseContent FromLogStreamSplunkResponseSchema(
    ...
    /// </summary>
    public static UpdateLogStreamResponseContent FromLogStreamSumoResponseSchema(
    ...
    /// </summary>
    public static UpdateLogStreamResponseContent FromLogStreamSegmentResponseSchema(
    ...
    /// </summary>
    public static UpdateLogStreamResponseContent FromLogStreamMixpanelResponseSchema(
    ...
    public override bool Equals(object? obj)
    {
        ...
        if (ReferenceEquals(this, obj))
            return true;
        if (obj is not UpdateLogStreamResponseContent other)
            return false;
    ...
    public static implicit operator UpdateLogStreamResponseContent(
        Auth0.ManagementApi.LogStreamHttpResponseSchema value
    ) => new("logStreamHttpResponseSchema", value);
    ...
    [Serializable]
    internal sealed class JsonConverter : JsonConverter<UpdateLogStreamResponseContent>
    {
        ...
        )
        {
            ...
            if (reader.TokenType == JsonTokenType.StartObject)
            {
                ...
                foreach (var (key, type) in types)
                {
                    try
                    {
                        ...
                        if (value != null)
                        {
                            UpdateLogStreamResponseContent result = new(key, value);
                            return result;
                        }
                    }
                    catch (JsonException)
            ...
            throw new JsonException(
                $"Cannot deserialize JSON token {reader.TokenType} into UpdateLogStreamResponseContent"
            );
        }

        public override void Write(
            Utf8JsonWriter writer,
            UpdateLogStreamResponseContent value,
            JsonSerializerOptions options
        )
        {
            if (value == null)
        ...
        )
        {
            ...
            UpdateLogStreamResponseContent result = new("string", stringValue);
            return result;
        }
