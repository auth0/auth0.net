...
/// </summary>
[Serializable]
public record CreateConnectionRequestContentRenren : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required CreateConnectionRequestContentRenrenStrategy Strategy { get; set; }

    [Optional]
    [JsonPropertyName("options")]
    public ConnectionOptionsRenren? Options { get; set; }
