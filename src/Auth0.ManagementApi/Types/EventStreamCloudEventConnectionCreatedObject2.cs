...
[Serializable]
public record EventStreamCloudEventConnectionCreatedObject2 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionCreatedObject2Authentication? Authentication { get; set; }

    [Optional]
    [JsonPropertyName("connected_accounts")]
    public EventStreamCloudEventConnectionCreatedObject2ConnectedAccounts? ConnectedAccounts { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedObject2Metadata? Metadata { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedObject2Options? Options { get; set; }
    ...
    public required EventStreamCloudEventConnectionCreatedObject2StrategyEnum Strategy { get; set; }
