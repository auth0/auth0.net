...
/// </summary>
[Serializable]
public record EventStreamCloudEventGroupMemberDeletedCloudEvent : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventGroupMemberDeletedCloudEventTypeEnum Type { get; set; }
    ...
    public required EventStreamCloudEventGroupMemberDeletedData Data { get; set; }
