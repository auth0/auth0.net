...
[Serializable]
public record ListVerifiableCredentialTemplatesPaginatedResponseContent : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public IEnumerable<VerifiableCredentialTemplateResponse>? Templates { get; set; }
