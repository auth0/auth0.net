...
/// </summary>
[Serializable]
public record ConnectionResponseContentWindowsLive : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required ConnectionResponseContentWindowsLiveStrategy Strategy { get; set; }

    [Optional]
    [JsonPropertyName("options")]
    public ConnectionOptionsWindowsLive? Options { get; set; }
