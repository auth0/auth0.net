...
public class EventStreamDestinationPatch
{
    ...
    public void Visit(
        global::System.Action<Auth0.ManagementApi.EventStreamWebhookDestination> onEventStreamWebhookDestination,
        global::System.Action<Auth0.ManagementApi.EventStreamActionDestination> onEventStreamActionDestination
    )
    {
        switch (Type)
        {
