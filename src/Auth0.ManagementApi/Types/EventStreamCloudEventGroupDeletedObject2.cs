...
/// </summary>
[Serializable]
public record EventStreamCloudEventGroupDeletedObject2 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventGroupDeletedObject2TypeEnum Type { get; set; }
