...
[Serializable]
public record EventStreamCloudEventConnectionUpdatedObject2 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionUpdatedObject2Authentication? Authentication { get; set; }

    [Optional]
    [JsonPropertyName("connected_accounts")]
    public EventStreamCloudEventConnectionUpdatedObject2ConnectedAccounts? ConnectedAccounts { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedObject2Metadata? Metadata { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedObject2Options? Options { get; set; }
    ...
    public required EventStreamCloudEventConnectionUpdatedObject2StrategyEnum Strategy { get; set; }
