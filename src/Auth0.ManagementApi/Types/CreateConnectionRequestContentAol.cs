...
/// </summary>
[Serializable]
public record CreateConnectionRequestContentAol : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required CreateConnectionRequestContentAolStrategy Strategy { get; set; }

    [Optional]
    [JsonPropertyName("options")]
    public ConnectionOptionsAol? Options { get; set; }
