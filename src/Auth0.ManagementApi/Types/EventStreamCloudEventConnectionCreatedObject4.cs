...
[Serializable]
public record EventStreamCloudEventConnectionCreatedObject4 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionCreatedObject4Authentication? Authentication { get; set; }

    [Optional]
    [JsonPropertyName("connected_accounts")]
    public EventStreamCloudEventConnectionCreatedObject4ConnectedAccounts? ConnectedAccounts { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedObject4Metadata? Metadata { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedObject4Options? Options { get; set; }
    ...
    public required EventStreamCloudEventConnectionCreatedObject4StrategyEnum Strategy { get; set; }
