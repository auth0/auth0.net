...
public class CreateFlowsVaultConnectionAirtable
{
    ...
    public void Visit(
        System.Action<Auth0.ManagementApi.CreateFlowsVaultConnectionAirtableApiKey> onCreateFlowsVaultConnectionAirtableApiKey,
        System.Action<Auth0.ManagementApi.CreateFlowsVaultConnectionAirtableUninitialized> onCreateFlowsVaultConnectionAirtableUninitialized
    )
    {
        switch (Type)
        {
