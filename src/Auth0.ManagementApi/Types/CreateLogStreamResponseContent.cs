...
{
    private CreateLogStreamResponseContent(string type, object? value)
    {
        Type = type;
        Value = value;
    }
    ...
    /// </summary>
    public static CreateLogStreamResponseContent FromLogStreamHttpResponseSchema(
    ...
    /// </summary>
    public static CreateLogStreamResponseContent FromLogStreamEventBridgeResponseSchema(
    ...
    /// </summary>
    public static CreateLogStreamResponseContent FromLogStreamEventGridResponseSchema(
    ...
    /// </summary>
    public static CreateLogStreamResponseContent FromLogStreamDatadogResponseSchema(
    ...
    /// </summary>
    public static CreateLogStreamResponseContent FromLogStreamSplunkResponseSchema(
    ...
    /// </summary>
    public static CreateLogStreamResponseContent FromLogStreamSumoResponseSchema(
    ...
    /// </summary>
    public static CreateLogStreamResponseContent FromLogStreamSegmentResponseSchema(
    ...
    /// </summary>
    public static CreateLogStreamResponseContent FromLogStreamMixpanelResponseSchema(
    ...
    public override bool Equals(object? obj)
    {
        ...
        if (ReferenceEquals(this, obj))
            return true;
        if (obj is not CreateLogStreamResponseContent other)
            return false;
    ...
    public static implicit operator CreateLogStreamResponseContent(
        Auth0.ManagementApi.LogStreamHttpResponseSchema value
    ) => new("logStreamHttpResponseSchema", value);
    ...
    [Serializable]
    internal sealed class JsonConverter : JsonConverter<CreateLogStreamResponseContent>
    {
        public override CreateLogStreamResponseContent? Read(
        ...
        )
        {
            ...
            if (reader.TokenType == JsonTokenType.StartObject)
            {
                ...
                foreach (var (key, type) in types)
                {
                    try
                    {
                        ...
                        if (value != null)
                        {
                            CreateLogStreamResponseContent result = new(key, value);
                            return result;
                        }
                    }
                    catch (JsonException)
            ...
            throw new JsonException(
                $"Cannot deserialize JSON token {reader.TokenType} into CreateLogStreamResponseContent"
            );
        }

        public override void Write(
            Utf8JsonWriter writer,
            CreateLogStreamResponseContent value,
            JsonSerializerOptions options
        )
        {
            if (value == null)
        ...
        public override CreateLogStreamResponseContent ReadAsPropertyName(
            ref Utf8JsonReader reader,
            global::System.Type typeToConvert,
            JsonSerializerOptions options
        )
        {
            ...
            CreateLogStreamResponseContent result = new("string", stringValue);
            return result;
        }
