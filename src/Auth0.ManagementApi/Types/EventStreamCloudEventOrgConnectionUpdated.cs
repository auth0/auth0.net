...
/// </summary>
[Serializable]
public record EventStreamCloudEventOrgConnectionUpdated : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventOrgConnectionUpdatedCloudEvent Event { get; set; }
