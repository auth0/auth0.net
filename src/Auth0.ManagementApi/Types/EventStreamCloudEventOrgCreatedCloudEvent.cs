...
/// </summary>
[Serializable]
public record EventStreamCloudEventOrgCreatedCloudEvent : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventOrgCreatedCloudEventTypeEnum Type { get; set; }
    ...
    public required EventStreamCloudEventOrgCreatedData Data { get; set; }
