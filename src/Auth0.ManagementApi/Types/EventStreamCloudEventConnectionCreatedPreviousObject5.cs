...
[Serializable]
public record EventStreamCloudEventConnectionCreatedPreviousObject5 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionCreatedPreviousObject5Authentication? Authentication { get; set; }

    [Optional]
    [JsonPropertyName("connected_accounts")]
    public EventStreamCloudEventConnectionCreatedPreviousObject5ConnectedAccounts? ConnectedAccounts { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedPreviousObject5Metadata? Metadata { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedPreviousObject5Options? Options { get; set; }

    [JsonPropertyName("strategy")]
    public required EventStreamCloudEventConnectionCreatedPreviousObject5StrategyEnum Strategy { get; set; }
