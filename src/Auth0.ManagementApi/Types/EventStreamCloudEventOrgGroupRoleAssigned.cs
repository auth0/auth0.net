...
/// </summary>
[Serializable]
public record EventStreamCloudEventOrgGroupRoleAssigned : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventOrgGroupRoleAssignedCloudEvent Event { get; set; }
