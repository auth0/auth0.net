...
[Serializable]
public record EventStreamCloudEventConnectionUpdatedPreviousObject2 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject2Authentication? Authentication { get; set; }

    [Optional]
    [JsonPropertyName("connected_accounts")]
    public EventStreamCloudEventConnectionUpdatedPreviousObject2ConnectedAccounts? ConnectedAccounts { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject2Metadata? Metadata { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject2Options? Options { get; set; }
    ...
    public required EventStreamCloudEventConnectionUpdatedPreviousObject2StrategyEnum Strategy { get; set; }
