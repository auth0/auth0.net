...
/// </summary>
[Serializable]
public record EventStreamCloudEventGroupUpdatedPreviousObject0 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventGroupUpdatedPreviousObject0TypeEnum Type { get; set; }
