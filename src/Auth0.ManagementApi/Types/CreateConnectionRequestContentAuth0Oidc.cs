...
/// </summary>
[Serializable]
public record CreateConnectionRequestContentAuth0Oidc : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required CreateConnectionRequestContentAuth0OidcStrategy Strategy { get; set; }
