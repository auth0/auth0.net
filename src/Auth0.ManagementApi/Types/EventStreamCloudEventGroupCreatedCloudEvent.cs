...
/// </summary>
[Serializable]
public record EventStreamCloudEventGroupCreatedCloudEvent : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventGroupCreatedCloudEventTypeEnum Type { get; set; }
    ...
    public required EventStreamCloudEventGroupCreatedData Data { get; set; }
