...
/// </summary>
[Serializable]
public record EventStreamCloudEventConnectionDeletedPreviousObject2Options : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject2OptionsAssertionDecryptionSettings? AssertionDecryptionSettings { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject2OptionsDigestAlgorithmEnum? DigestAlgorithm { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject2OptionsIdpinitiated? Idpinitiated { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject2OptionsProtocolBindingEnum? ProtocolBinding { get; set; }

    [Optional]
    [JsonPropertyName("set_user_root_attributes")]
    public EventStreamCloudEventConnectionDeletedPreviousObject2OptionsSetUserRootAttributesEnum? SetUserRootAttributes { get; set; }

    [Optional]
    [JsonPropertyName("signatureAlgorithm")]
    public EventStreamCloudEventConnectionDeletedPreviousObject2OptionsSignatureAlgorithmEnum? SignatureAlgorithm { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject2OptionsSubject? Subject { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject2OptionsOidcMetadata? OidcMetadata { get; set; }
