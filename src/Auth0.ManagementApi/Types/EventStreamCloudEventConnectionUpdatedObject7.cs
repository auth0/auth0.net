...
[Serializable]
public record EventStreamCloudEventConnectionUpdatedObject7 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionUpdatedObject7Authentication? Authentication { get; set; }

    [Optional]
    [JsonPropertyName("connected_accounts")]
    public EventStreamCloudEventConnectionUpdatedObject7ConnectedAccounts? ConnectedAccounts { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedObject7Metadata? Metadata { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedObject7Options? Options { get; set; }
    ...
    public required EventStreamCloudEventConnectionUpdatedObject7StrategyEnum Strategy { get; set; }
