...
[Serializable]
public record EventStreamCloudEventConnectionCreatedObject3 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionCreatedObject3Authentication? Authentication { get; set; }

    [Optional]
    [JsonPropertyName("connected_accounts")]
    public EventStreamCloudEventConnectionCreatedObject3ConnectedAccounts? ConnectedAccounts { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedObject3Metadata? Metadata { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedObject3Options? Options { get; set; }
    ...
    public required EventStreamCloudEventConnectionCreatedObject3StrategyEnum Strategy { get; set; }
