...
/// </summary>
[Serializable]
public record EventStreamCloudEventConnectionUpdatedCloudEvent : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventConnectionUpdatedCloudEventTypeEnum Type { get; set; }
    ...
    public required EventStreamCloudEventConnectionUpdatedData Data { get; set; }
