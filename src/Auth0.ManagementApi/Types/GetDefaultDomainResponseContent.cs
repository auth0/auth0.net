...
public class GetDefaultDomainResponseContent
{
    ...
    public void Visit(
        System.Action<Auth0.ManagementApi.GetDefaultCustomDomainResponseContent> onGetDefaultCustomDomainResponseContent,
        System.Action<Auth0.ManagementApi.GetDefaultCanonicalDomainResponseContent> onGetDefaultCanonicalDomainResponseContent
    )
    {
        switch (Type)
        {
