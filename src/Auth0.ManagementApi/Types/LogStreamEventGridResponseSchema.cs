...
[Serializable]
public record LogStreamEventGridResponseSchema : IJsonOnDeserialized, IJsonOnSerializing
{
    [JsonExtensionData]
    ...
    public LogStreamEventGridEnum? Type { get; set; }
    ...
    public LogStreamEventGridSink? Sink { get; set; }
