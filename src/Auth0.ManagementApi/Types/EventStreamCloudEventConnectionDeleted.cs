...
/// </summary>
[Serializable]
public record EventStreamCloudEventConnectionDeleted : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventConnectionDeletedCloudEvent Event { get; set; }
