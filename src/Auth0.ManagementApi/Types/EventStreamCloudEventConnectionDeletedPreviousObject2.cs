...
[Serializable]
public record EventStreamCloudEventConnectionDeletedPreviousObject2 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject2Authentication? Authentication { get; set; }

    [Optional]
    [JsonPropertyName("connected_accounts")]
    public EventStreamCloudEventConnectionDeletedPreviousObject2ConnectedAccounts? ConnectedAccounts { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject2Metadata? Metadata { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject2Options? Options { get; set; }
    ...
    public required EventStreamCloudEventConnectionDeletedPreviousObject2StrategyEnum Strategy { get; set; }
