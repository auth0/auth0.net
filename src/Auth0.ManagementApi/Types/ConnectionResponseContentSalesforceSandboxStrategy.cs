...
[JsonConverter(
    typeof(ConnectionResponseContentSalesforceSandboxStrategy.ConnectionResponseContentSalesforceSandboxStrategySerializer)
)]
[Serializable]
public readonly record struct ConnectionResponseContentSalesforceSandboxStrategy : IStringEnum
{
    ...
    internal class ConnectionResponseContentSalesforceSandboxStrategySerializer
        : JsonConverter<ConnectionResponseContentSalesforceSandboxStrategy>
    {
        public override ConnectionResponseContentSalesforceSandboxStrategy Read(
        ...
        )
        {
            ...
            return new ConnectionResponseContentSalesforceSandboxStrategy(stringValue);
        }
        ...
        public override ConnectionResponseContentSalesforceSandboxStrategy ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
