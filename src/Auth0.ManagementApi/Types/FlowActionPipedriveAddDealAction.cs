...
public readonly record struct FlowActionPipedriveAddDealAction : IStringEnum
{
    ...
    internal class FlowActionPipedriveAddDealActionSerializer
        : JsonConverter<FlowActionPipedriveAddDealAction>
    {
        public override FlowActionPipedriveAddDealAction Read(
        ...
        )
        {
            ...
            return new FlowActionPipedriveAddDealAction(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            FlowActionPipedriveAddDealAction value,
            JsonSerializerOptions options
        )
        {
        ...
        public override FlowActionPipedriveAddDealAction ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
