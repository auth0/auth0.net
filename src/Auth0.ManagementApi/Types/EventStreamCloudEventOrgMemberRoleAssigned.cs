...
/// </summary>
[Serializable]
public record EventStreamCloudEventOrgMemberRoleAssigned : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventOrgMemberRoleAssignedCloudEvent Event { get; set; }
