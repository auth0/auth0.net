...
[JsonConverter(
    typeof(GuardianFactorPhoneFactorMessageTypeEnum.GuardianFactorPhoneFactorMessageTypeEnumSerializer)
)]
[Serializable]
public readonly record struct GuardianFactorPhoneFactorMessageTypeEnum : IStringEnum
{
    ...
    internal class GuardianFactorPhoneFactorMessageTypeEnumSerializer
        : JsonConverter<GuardianFactorPhoneFactorMessageTypeEnum>
    {
        public override GuardianFactorPhoneFactorMessageTypeEnum Read(
        ...
        )
        {
            ...
            return new GuardianFactorPhoneFactorMessageTypeEnum(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            GuardianFactorPhoneFactorMessageTypeEnum value,
            JsonSerializerOptions options
        )
        {
        ...
        public override GuardianFactorPhoneFactorMessageTypeEnum ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
