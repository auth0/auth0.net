...
[Serializable]
public record EventStreamCloudEventConnectionUpdatedPreviousObject1 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject1Authentication? Authentication { get; set; }

    [Optional]
    [JsonPropertyName("connected_accounts")]
    public EventStreamCloudEventConnectionUpdatedPreviousObject1ConnectedAccounts? ConnectedAccounts { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject1Metadata? Metadata { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject1Options? Options { get; set; }
    ...
    public required EventStreamCloudEventConnectionUpdatedPreviousObject1StrategyEnum Strategy { get; set; }
