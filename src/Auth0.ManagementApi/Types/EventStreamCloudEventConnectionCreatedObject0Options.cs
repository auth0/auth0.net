...
/// </summary>
[Serializable]
public record EventStreamCloudEventConnectionCreatedObject0Options : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionCreatedObject0OptionsConnectionSettings? ConnectionSettings { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedObject0OptionsDpopSigningAlgEnum? DpopSigningAlg { get; set; }

    [Optional]
    [JsonPropertyName("federated_connections_access_tokens")]
    public EventStreamCloudEventConnectionCreatedObject0OptionsFederatedConnectionsAccessTokens? FederatedConnectionsAccessTokens { get; set; }
    ...
    public IEnumerable<EventStreamCloudEventConnectionCreatedObject0OptionsIdTokenSignedResponseAlgsItemEnum>? IdTokenSignedResponseAlgs { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedObject0OptionsOidcMetadata? OidcMetadata { get; set; }

    [Optional]
    [JsonPropertyName("schema_version")]
    public EventStreamCloudEventConnectionCreatedObject0OptionsSchemaVersionEnum? SchemaVersion { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedObject0OptionsSetUserRootAttributesEnum? SetUserRootAttributes { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedObject0OptionsTokenEndpointAuthMethodEnum? TokenEndpointAuthMethod { get; set; }

    [Optional]
    [JsonPropertyName("token_endpoint_auth_signing_alg")]
    public EventStreamCloudEventConnectionCreatedObject0OptionsTokenEndpointAuthSigningAlgEnum? TokenEndpointAuthSigningAlg { get; set; }

    [Optional]
    [JsonPropertyName("token_endpoint_jwtca_aud_format")]
    public EventStreamCloudEventConnectionCreatedObject0OptionsTokenEndpointJwtcaAudFormatEnum? TokenEndpointJwtcaAudFormat { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedObject0OptionsAttributeMap? AttributeMap { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedObject0OptionsTypeEnum? Type { get; set; }
