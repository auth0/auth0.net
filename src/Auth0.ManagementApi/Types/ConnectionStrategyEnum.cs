...
public readonly record struct ConnectionStrategyEnum : IStringEnum
{
    ...
    public static readonly ConnectionStrategyEnum Asana = new(Values.Asana);

    public static readonly ConnectionStrategyEnum Atlassian = new(Values.Atlassian);

    public static readonly ConnectionStrategyEnum CloudflareMcp = new(Values.CloudflareMcp);

    public static readonly ConnectionStrategyEnum Gitlab = new(Values.Gitlab);
    ...
    public static readonly ConnectionStrategyEnum Slack = new(Values.Slack);
