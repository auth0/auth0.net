...
/// </summary>
[Serializable]
public record EventStreamCloudEventOrgGroupRoleDeletedCloudEvent : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventOrgGroupRoleDeletedCloudEventTypeEnum Type { get; set; }
    ...
    public required EventStreamCloudEventOrgGroupRoleDeletedData Data { get; set; }
