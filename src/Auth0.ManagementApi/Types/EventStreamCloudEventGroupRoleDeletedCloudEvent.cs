...
/// </summary>
[Serializable]
public record EventStreamCloudEventGroupRoleDeletedCloudEvent : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventGroupRoleDeletedCloudEventTypeEnum Type { get; set; }
    ...
    public required EventStreamCloudEventGroupRoleDeletedData Data { get; set; }
