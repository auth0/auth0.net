...
/// </summary>
[Serializable]
public record EventStreamCloudEventOrgConnectionUpdatedCloudEvent : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventOrgConnectionUpdatedCloudEventTypeEnum Type { get; set; }
    ...
    public required EventStreamCloudEventOrgConnectionUpdatedData Data { get; set; }
