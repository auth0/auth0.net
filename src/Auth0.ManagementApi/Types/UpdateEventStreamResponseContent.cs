...
{
    private UpdateEventStreamResponseContent(string type, object? value)
    {
        Type = type;
        Value = value;
    }
    ...
    /// </summary>
    public static UpdateEventStreamResponseContent FromEventStreamWebhookResponseContent(
    ...
    /// </summary>
    public static UpdateEventStreamResponseContent FromEventStreamEventBridgeResponseContent(
    ...
    /// </summary>
    public static UpdateEventStreamResponseContent FromEventStreamActionResponseContent(
    ...
    public override bool Equals(object? obj)
    {
        ...
        if (ReferenceEquals(this, obj))
            return true;
        if (obj is not UpdateEventStreamResponseContent other)
            return false;
    ...
    public static implicit operator UpdateEventStreamResponseContent(
        Auth0.ManagementApi.EventStreamWebhookResponseContent value
    ) => new("eventStreamWebhookResponseContent", value);
    ...
    [Serializable]
    internal sealed class JsonConverter : JsonConverter<UpdateEventStreamResponseContent>
    {
        public override UpdateEventStreamResponseContent? Read(
        ...
        )
        {
            ...
            if (reader.TokenType == JsonTokenType.StartObject)
            {
                ...
                foreach (var (key, type) in types)
                {
                    try
                    {
                        ...
                        if (value != null)
                        {
                            UpdateEventStreamResponseContent result = new(key, value);
                            return result;
                        }
                    }
                    catch (JsonException)
            ...
            throw new JsonException(
                $"Cannot deserialize JSON token {reader.TokenType} into UpdateEventStreamResponseContent"
            );
        }

        public override void Write(
            Utf8JsonWriter writer,
            UpdateEventStreamResponseContent value,
            JsonSerializerOptions options
        )
        {
            if (value == null)
        ...
        public override UpdateEventStreamResponseContent ReadAsPropertyName(
            ref Utf8JsonReader reader,
            global::System.Type typeToConvert,
            JsonSerializerOptions options
        )
        {
            ...
            UpdateEventStreamResponseContent result = new("string", stringValue);
            return result;
        }
