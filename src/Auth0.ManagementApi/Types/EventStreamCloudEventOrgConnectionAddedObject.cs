...
/// </summary>
[Serializable]
public record EventStreamCloudEventOrgConnectionAddedObject : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventOrgConnectionAddedObjectOrganization Organization { get; set; }

    [JsonPropertyName("connection")]
    public required EventStreamCloudEventOrgConnectionAddedObjectConnection Connection { get; set; }
    ...
    public EventStreamCloudEventOrgConnectionAddedObjectOrganizationAccessLevel? OrganizationAccessLevel { get; set; }
