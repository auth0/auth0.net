...
[JsonConverter(typeof(FlowActionStripeGetCustomerType.FlowActionStripeGetCustomerTypeSerializer))]
[Serializable]
public readonly record struct FlowActionStripeGetCustomerType : IStringEnum
{
    ...
    internal class FlowActionStripeGetCustomerTypeSerializer
        : JsonConverter<FlowActionStripeGetCustomerType>
    {
        public override FlowActionStripeGetCustomerType Read(
        ...
        )
        {
            ...
            return new FlowActionStripeGetCustomerType(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            FlowActionStripeGetCustomerType value,
            JsonSerializerOptions options
        )
        {
        ...
        public override FlowActionStripeGetCustomerType ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
