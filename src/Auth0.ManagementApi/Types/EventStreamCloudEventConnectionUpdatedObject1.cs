...
[Serializable]
public record EventStreamCloudEventConnectionUpdatedObject1 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionUpdatedObject1Authentication? Authentication { get; set; }

    [Optional]
    [JsonPropertyName("connected_accounts")]
    public EventStreamCloudEventConnectionUpdatedObject1ConnectedAccounts? ConnectedAccounts { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedObject1Metadata? Metadata { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedObject1Options? Options { get; set; }
    ...
    public required EventStreamCloudEventConnectionUpdatedObject1StrategyEnum Strategy { get; set; }
