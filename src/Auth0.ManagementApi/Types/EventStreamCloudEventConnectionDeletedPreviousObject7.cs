...
[Serializable]
public record EventStreamCloudEventConnectionDeletedPreviousObject7 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject7Authentication? Authentication { get; set; }

    [Optional]
    [JsonPropertyName("connected_accounts")]
    public EventStreamCloudEventConnectionDeletedPreviousObject7ConnectedAccounts? ConnectedAccounts { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject7Metadata? Metadata { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject7Options? Options { get; set; }
    ...
    public required EventStreamCloudEventConnectionDeletedPreviousObject7StrategyEnum Strategy { get; set; }
