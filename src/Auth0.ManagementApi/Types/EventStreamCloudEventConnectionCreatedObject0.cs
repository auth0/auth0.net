...
[Serializable]
public record EventStreamCloudEventConnectionCreatedObject0 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionCreatedObject0Authentication? Authentication { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedObject0Metadata? Metadata { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedObject0ConnectedAccounts? ConnectedAccounts { get; set; }

    [Optional]
    [JsonPropertyName("options")]
    public EventStreamCloudEventConnectionCreatedObject0Options? Options { get; set; }
    ...
    public required EventStreamCloudEventConnectionCreatedObject0StrategyEnum Strategy { get; set; }
