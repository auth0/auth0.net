...
public class CreateFlowsVaultConnectionClearbit
{
    ...
    public void Visit(
        System.Action<Auth0.ManagementApi.CreateFlowsVaultConnectionClearbitApiKey> onCreateFlowsVaultConnectionClearbitApiKey,
        System.Action<Auth0.ManagementApi.CreateFlowsVaultConnectionClearbitUninitialized> onCreateFlowsVaultConnectionClearbitUninitialized
    )
    {
        switch (Type)
        {
