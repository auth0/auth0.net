...
/// </summary>
[Serializable]
public record EventStreamCloudEventConnectionCreatedCloudEvent : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventConnectionCreatedCloudEventTypeEnum Type { get; set; }
    ...
    public required EventStreamCloudEventConnectionCreatedData Data { get; set; }
