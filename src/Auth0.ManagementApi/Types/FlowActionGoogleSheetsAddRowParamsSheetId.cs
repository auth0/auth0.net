...
{
    private FlowActionGoogleSheetsAddRowParamsSheetId(string type, object? value)
    {
        Type = type;
        Value = value;
    }
    ...
    /// </summary>
    public static FlowActionGoogleSheetsAddRowParamsSheetId FromInt(int value) => new("int", value);
    ...
    public override bool Equals(object? obj)
    {
        ...
        if (ReferenceEquals(this, obj))
            return true;
        if (obj is not FlowActionGoogleSheetsAddRowParamsSheetId other)
            return false;
    ...
    [Serializable]
    internal sealed class JsonConverter : JsonConverter<FlowActionGoogleSheetsAddRowParamsSheetId>
    {
        ...
        )
        {
            ...
            if (reader.TokenType == JsonTokenType.Number)
            {
                ...
                {
                    FlowActionGoogleSheetsAddRowParamsSheetId intResult = new("int", intValue);
                    return intResult;
                }
            }
            ...
            if (reader.TokenType == JsonTokenType.String)
            {
                ...
                {
                    FlowActionGoogleSheetsAddRowParamsSheetId intFromStringResult = new(
                        "int",
                        intFromStringValue
                    );
                ...
                FlowActionGoogleSheetsAddRowParamsSheetId stringResult = new("string", stringValue);
                return stringResult;
            }

            throw new JsonException(
                $"Cannot deserialize JSON token {reader.TokenType} into FlowActionGoogleSheetsAddRowParamsSheetId"
            );
        }

        public override void Write(
            Utf8JsonWriter writer,
            FlowActionGoogleSheetsAddRowParamsSheetId value,
            JsonSerializerOptions options
        )
        {
            if (value == null)
        ...
        {
            var stringValue = reader.GetString()!;
            FlowActionGoogleSheetsAddRowParamsSheetId result = new("string", stringValue);
            return result;
        }
