...
/// </summary>
[Serializable]
public record EventStreamCloudEventOrgConnectionRemoved : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventOrgConnectionRemovedCloudEvent Event { get; set; }
