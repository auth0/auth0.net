...
[Serializable]
public record EventStreamCloudEventConnectionUpdatedObject3 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionUpdatedObject3Authentication? Authentication { get; set; }

    [Optional]
    [JsonPropertyName("connected_accounts")]
    public EventStreamCloudEventConnectionUpdatedObject3ConnectedAccounts? ConnectedAccounts { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedObject3Metadata? Metadata { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedObject3Options? Options { get; set; }
    ...
    public required EventStreamCloudEventConnectionUpdatedObject3StrategyEnum Strategy { get; set; }
