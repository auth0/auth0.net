...
/// </summary>
[Serializable]
public record EventStreamCloudEventConnectionUpdated : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventConnectionUpdatedCloudEvent Event { get; set; }
