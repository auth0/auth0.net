...
[Serializable]
public record EventStreamCloudEventConnectionDeletedObject0 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionDeletedObject0Authentication? Authentication { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedObject0Metadata? Metadata { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedObject0ConnectedAccounts? ConnectedAccounts { get; set; }

    [Optional]
    [JsonPropertyName("options")]
    public EventStreamCloudEventConnectionDeletedObject0Options? Options { get; set; }
    ...
    public required EventStreamCloudEventConnectionDeletedObject0StrategyEnum Strategy { get; set; }
