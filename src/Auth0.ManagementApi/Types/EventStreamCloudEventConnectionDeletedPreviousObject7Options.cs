...
/// </summary>
[Serializable]
public record EventStreamCloudEventConnectionDeletedPreviousObject7Options : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject7OptionsFederatedConnectionsAccessTokens? FederatedConnectionsAccessTokens { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject7OptionsIdentityApiEnum? IdentityApi { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject7OptionsSetUserRootAttributesEnum? SetUserRootAttributes { get; set; }

    [Optional]
    [JsonPropertyName("should_trust_email_verified_connection")]
    public EventStreamCloudEventConnectionDeletedPreviousObject7OptionsShouldTrustEmailVerifiedConnectionEnum? ShouldTrustEmailVerifiedConnection { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject7OptionsUseridAttributeEnum? UseridAttribute { get; set; }

    [Optional]
    [JsonPropertyName("waad_protocol")]
    public EventStreamCloudEventConnectionDeletedPreviousObject7OptionsWaadProtocolEnum? WaadProtocol { get; set; }
