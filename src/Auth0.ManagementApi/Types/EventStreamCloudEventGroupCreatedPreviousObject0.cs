...
/// </summary>
[Serializable]
public record EventStreamCloudEventGroupCreatedPreviousObject0 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventGroupCreatedPreviousObject0TypeEnum Type { get; set; }
