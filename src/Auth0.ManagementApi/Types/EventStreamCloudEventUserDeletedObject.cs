...
/// </summary>
[Serializable]
public record EventStreamCloudEventUserDeletedObject : IJsonOnDeserialized, IJsonOnSerializing
{
    [JsonExtensionData]
    ...
    public IEnumerable<EventStreamCloudEventUserDeletedObjectIdentitiesItem> Identities { get; set; } =
        new List<EventStreamCloudEventUserDeletedObjectIdentitiesItem>();
