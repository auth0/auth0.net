...
[JsonConverter(
    typeof(CreateConnectionRequestContentTwitterStrategy.CreateConnectionRequestContentTwitterStrategySerializer)
)]
[Serializable]
public readonly record struct CreateConnectionRequestContentTwitterStrategy : IStringEnum
{
    ...
    internal class CreateConnectionRequestContentTwitterStrategySerializer
        : JsonConverter<CreateConnectionRequestContentTwitterStrategy>
    {
        public override CreateConnectionRequestContentTwitterStrategy Read(
        ...
        )
        {
            ...
            return new CreateConnectionRequestContentTwitterStrategy(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            CreateConnectionRequestContentTwitterStrategy value,
            JsonSerializerOptions options
        )
        {
        ...
        public override CreateConnectionRequestContentTwitterStrategy ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
