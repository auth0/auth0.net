...
[Serializable]
public record CreateLogStreamDatadogRequestBody : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required LogStreamDatadogEnum Type { get; set; }
    ...
    public required LogStreamDatadogSink Sink { get; set; }
