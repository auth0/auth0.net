...
public readonly record struct FlowActionTwilioSendSmsAction : IStringEnum
{
    ...
    internal class FlowActionTwilioSendSmsActionSerializer
        : JsonConverter<FlowActionTwilioSendSmsAction>
    {
        public override FlowActionTwilioSendSmsAction Read(
        ...
        )
        {
            ...
            return new FlowActionTwilioSendSmsAction(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            FlowActionTwilioSendSmsAction value,
            JsonSerializerOptions options
        )
        {
        ...
        public override FlowActionTwilioSendSmsAction ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
