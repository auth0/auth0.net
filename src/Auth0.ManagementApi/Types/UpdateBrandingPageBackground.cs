...
[Serializable]
public class UpdateBrandingPageBackground
{
    private UpdateBrandingPageBackground(string type, object? value)
    {
        Type = type;
        Value = value;
    }
    ...
    /// </summary>
    public static UpdateBrandingPageBackground FromString(string value) => new("string", value);

    /// <summary>
    /// Factory method to create a union from a Dictionary<string, object?> value.
    /// </summary>
    public static UpdateBrandingPageBackground FromMapOfStringToUnknown(
    ...
    public override bool Equals(object? obj)
    {
        ...
        if (ReferenceEquals(this, obj))
            return true;
        if (obj is not UpdateBrandingPageBackground other)
            return false;
    ...
    public static implicit operator UpdateBrandingPageBackground(string value) =>
        new("string", value);

    [Serializable]
    internal sealed class JsonConverter : JsonConverter<UpdateBrandingPageBackground>
    {
        public override UpdateBrandingPageBackground? Read(
        ...
        )
        {
            ...
            if (reader.TokenType == JsonTokenType.String)
            {
                ...
                UpdateBrandingPageBackground stringResult = new("string", stringValue);
                return stringResult;
            }
            ...
            if (reader.TokenType == JsonTokenType.StartArray)
            {
                ...
                foreach (var (key, type) in types)
                {
                    try
                    {
                        ...
                        if (value != null)
                        {
                            UpdateBrandingPageBackground result = new(key, value);
                            return result;
                        }
                    }
                    catch (JsonException)
            ...
            throw new JsonException(
                $"Cannot deserialize JSON token {reader.TokenType} into UpdateBrandingPageBackground"
            );
        }

        public override void Write(
            Utf8JsonWriter writer,
            UpdateBrandingPageBackground value,
            JsonSerializerOptions options
        )
        {
            if (value == null)
        ...
        public override UpdateBrandingPageBackground ReadAsPropertyName(
            ref Utf8JsonReader reader,
            System.Type typeToConvert,
            JsonSerializerOptions options
        )
        {
            var stringValue = reader.GetString()!;
            UpdateBrandingPageBackground result = new("string", stringValue);
            return result;
        }
