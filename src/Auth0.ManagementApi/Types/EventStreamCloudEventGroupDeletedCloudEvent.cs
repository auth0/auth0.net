...
/// </summary>
[Serializable]
public record EventStreamCloudEventGroupDeletedCloudEvent : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventGroupDeletedCloudEventTypeEnum Type { get; set; }
    ...
    public required EventStreamCloudEventGroupDeletedData Data { get; set; }
