...
{
    private FlowActionAuth0SendRequestParamsPayload(string type, object? value)
    {
        Type = type;
        Value = value;
    }
    ...
    /// </summary>
    public static FlowActionAuth0SendRequestParamsPayload FromListOfUnknown(
    ...
    /// </summary>
    public static FlowActionAuth0SendRequestParamsPayload FromFlowActionAuth0SendRequestParamsPayloadObject(
        Dictionary<string, object?> value
    ) => new("flowActionAuth0SendRequestParamsPayloadObject", value);
    ...
    /// <summary>
    /// Returns true if <see cref="Type"/> is "flowActionAuth0SendRequestParamsPayloadObject"
    /// </summary>
    public bool IsFlowActionAuth0SendRequestParamsPayloadObject() =>
        Type == "flowActionAuth0SendRequestParamsPayloadObject";
    ...
    /// <summary>
    /// Returns the value as a <see cref="Dictionary<string, object?>"/> if <see cref="Type"/> is 'flowActionAuth0SendRequestParamsPayloadObject', otherwise throws an exception.
    /// </summary>
    /// <exception cref="ManagementException">Thrown when <see cref="Type"/> is not 'flowActionAuth0SendRequestParamsPayloadObject'.</exception>
    public Dictionary<string, object?> AsFlowActionAuth0SendRequestParamsPayloadObject() =>
        IsFlowActionAuth0SendRequestParamsPayloadObject()
            ...
            : throw new ManagementException(
                "Union type is not 'flowActionAuth0SendRequestParamsPayloadObject'"
            );
    ...
    /// </summary>
    public bool TryGetFlowActionAuth0SendRequestParamsPayloadObject(
        out Dictionary<string, object?>? value
    )
    {
        if (Type == "flowActionAuth0SendRequestParamsPayloadObject")
        {
    ...
    public T Match<T>(
        ...
        Func<Dictionary<string, object?>, T> onFlowActionAuth0SendRequestParamsPayloadObject
    )
    {
        return Type switch
        {
            ...
            "flowActionAuth0SendRequestParamsPayloadObject" =>
                onFlowActionAuth0SendRequestParamsPayloadObject(
    ...
    public void Visit(
        ...
        System.Action<Dictionary<string, object?>> onFlowActionAuth0SendRequestParamsPayloadObject
    )
    {
        switch (Type)
        {
            ...
            case "list":
                ...
                break;
            case "flowActionAuth0SendRequestParamsPayloadObject":
                onFlowActionAuth0SendRequestParamsPayloadObject(
                    AsFlowActionAuth0SendRequestParamsPayloadObject()
                );
                break;
    ...
    public override bool Equals(object? obj)
    {
        ...
        if (ReferenceEquals(this, obj))
            return true;
        if (obj is not FlowActionAuth0SendRequestParamsPayload other)
            return false;
    ...
    public static implicit operator FlowActionAuth0SendRequestParamsPayload(
        Dictionary<string, object?> value
    ) => new("flowActionAuth0SendRequestParamsPayloadObject", value);

    [Serializable]
    internal sealed class JsonConverter : JsonConverter<FlowActionAuth0SendRequestParamsPayload>
    {
        public override FlowActionAuth0SendRequestParamsPayload? Read(
        ...
        )
        {
            ...
            if (reader.TokenType == JsonTokenType.String)
            {
                ...
                FlowActionAuth0SendRequestParamsPayload stringResult = new("string", stringValue);
                return stringResult;
            }
            ...
            if (reader.TokenType == JsonTokenType.StartArray)
            {
                ...
                foreach (var (key, type) in types)
                {
                    try
                    {
                        ...
                        if (value != null)
                        {
                            FlowActionAuth0SendRequestParamsPayload result = new(key, value);
                            return result;
                        }
                    }
                    catch (JsonException)
            ...
            throw new JsonException(
                $"Cannot deserialize JSON token {reader.TokenType} into FlowActionAuth0SendRequestParamsPayload"
            );
        }

        public override void Write(
            Utf8JsonWriter writer,
            FlowActionAuth0SendRequestParamsPayload value,
            JsonSerializerOptions options
        )
        {
            if (value == null)
        ...
        public override FlowActionAuth0SendRequestParamsPayload ReadAsPropertyName(
            ref Utf8JsonReader reader,
            System.Type typeToConvert,
            JsonSerializerOptions options
        )
        {
            var stringValue = reader.GetString()!;
            FlowActionAuth0SendRequestParamsPayload result = new("string", stringValue);
            return result;
        }
