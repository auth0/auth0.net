...
/// </summary>
[Serializable]
public record CreateConnectionRequestContentThirtySevenSignals : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required CreateConnectionRequestContentThirtySevenSignalsStrategy Strategy { get; set; }
