...
[Serializable]
public record EventStreamCloudEventConnectionUpdatedObject6 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionUpdatedObject6Authentication? Authentication { get; set; }

    [Optional]
    [JsonPropertyName("connected_accounts")]
    public EventStreamCloudEventConnectionUpdatedObject6ConnectedAccounts? ConnectedAccounts { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedObject6Metadata? Metadata { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedObject6Options? Options { get; set; }
    ...
    public required EventStreamCloudEventConnectionUpdatedObject6StrategyEnum Strategy { get; set; }
