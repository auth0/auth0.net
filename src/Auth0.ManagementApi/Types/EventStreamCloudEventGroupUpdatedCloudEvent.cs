...
/// </summary>
[Serializable]
public record EventStreamCloudEventGroupUpdatedCloudEvent : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventGroupUpdatedCloudEventTypeEnum Type { get; set; }
    ...
    public required EventStreamCloudEventGroupUpdatedData Data { get; set; }
