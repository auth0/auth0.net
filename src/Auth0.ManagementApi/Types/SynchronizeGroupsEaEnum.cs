...
[JsonConverter(typeof(SynchronizeGroupsEaEnum.SynchronizeGroupsEaEnumSerializer))]
[Serializable]
public readonly record struct SynchronizeGroupsEaEnum : IStringEnum
{
    ...
    internal class SynchronizeGroupsEaEnumSerializer : JsonConverter<SynchronizeGroupsEaEnum>
    {
        public override SynchronizeGroupsEaEnum Read(
        ...
        )
        {
            ...
            return new SynchronizeGroupsEaEnum(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            SynchronizeGroupsEaEnum value,
            JsonSerializerOptions options
        )
        {
        ...
        public override SynchronizeGroupsEaEnum ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
