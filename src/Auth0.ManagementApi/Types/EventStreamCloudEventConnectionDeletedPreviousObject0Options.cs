...
/// </summary>
[Serializable]
public record EventStreamCloudEventConnectionDeletedPreviousObject0Options : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject0OptionsConnectionSettings? ConnectionSettings { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject0OptionsDpopSigningAlgEnum? DpopSigningAlg { get; set; }

    [Optional]
    [JsonPropertyName("federated_connections_access_tokens")]
    public EventStreamCloudEventConnectionDeletedPreviousObject0OptionsFederatedConnectionsAccessTokens? FederatedConnectionsAccessTokens { get; set; }
    ...
    public IEnumerable<EventStreamCloudEventConnectionDeletedPreviousObject0OptionsIdTokenSignedResponseAlgsItemEnum>? IdTokenSignedResponseAlgs { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject0OptionsOidcMetadata? OidcMetadata { get; set; }

    [Optional]
    [JsonPropertyName("schema_version")]
    public EventStreamCloudEventConnectionDeletedPreviousObject0OptionsSchemaVersionEnum? SchemaVersion { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject0OptionsSetUserRootAttributesEnum? SetUserRootAttributes { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject0OptionsTokenEndpointAuthMethodEnum? TokenEndpointAuthMethod { get; set; }

    [Optional]
    [JsonPropertyName("token_endpoint_auth_signing_alg")]
    public EventStreamCloudEventConnectionDeletedPreviousObject0OptionsTokenEndpointAuthSigningAlgEnum? TokenEndpointAuthSigningAlg { get; set; }

    [Optional]
    [JsonPropertyName("token_endpoint_jwtca_aud_format")]
    public EventStreamCloudEventConnectionDeletedPreviousObject0OptionsTokenEndpointJwtcaAudFormatEnum? TokenEndpointJwtcaAudFormat { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject0OptionsAttributeMap? AttributeMap { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject0OptionsTypeEnum? Type { get; set; }
