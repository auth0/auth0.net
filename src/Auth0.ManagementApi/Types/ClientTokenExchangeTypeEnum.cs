...
[JsonConverter(typeof(ClientTokenExchangeTypeEnum.ClientTokenExchangeTypeEnumSerializer))]
[Serializable]
public readonly record struct ClientTokenExchangeTypeEnum : IStringEnum
{
    ...
    internal class ClientTokenExchangeTypeEnumSerializer
        : JsonConverter<ClientTokenExchangeTypeEnum>
    {
        public override ClientTokenExchangeTypeEnum Read(
        ...
        )
        {
            ...
            return new ClientTokenExchangeTypeEnum(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            ClientTokenExchangeTypeEnum value,
            JsonSerializerOptions options
        )
        {
        ...
        public override ClientTokenExchangeTypeEnum ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
