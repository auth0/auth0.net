...
/// </summary>
[Serializable]
public record EventStreamCloudEventOrgMemberDeletedCloudEvent : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventOrgMemberDeletedCloudEventTypeEnum Type { get; set; }
    ...
    public required EventStreamCloudEventOrgMemberDeletedData Data { get; set; }
