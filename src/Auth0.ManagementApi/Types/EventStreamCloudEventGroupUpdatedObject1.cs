...
/// </summary>
[Serializable]
public record EventStreamCloudEventGroupUpdatedObject1 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventGroupUpdatedObject1TypeEnum Type { get; set; }
