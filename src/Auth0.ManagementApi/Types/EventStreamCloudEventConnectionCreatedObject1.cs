...
[Serializable]
public record EventStreamCloudEventConnectionCreatedObject1 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionCreatedObject1Authentication? Authentication { get; set; }

    [Optional]
    [JsonPropertyName("connected_accounts")]
    public EventStreamCloudEventConnectionCreatedObject1ConnectedAccounts? ConnectedAccounts { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedObject1Metadata? Metadata { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedObject1Options? Options { get; set; }
    ...
    public required EventStreamCloudEventConnectionCreatedObject1StrategyEnum Strategy { get; set; }
