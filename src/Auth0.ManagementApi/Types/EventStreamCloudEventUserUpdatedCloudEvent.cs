...
/// </summary>
[Serializable]
public record EventStreamCloudEventUserUpdatedCloudEvent : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventUserUpdatedCloudEventTypeEnum Type { get; set; }
    ...
    public required EventStreamCloudEventUserUpdatedData Data { get; set; }
