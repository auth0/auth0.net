...
public record EventStreamCloudEventConnectionDeletedCloudEvent : IJsonOnDeserialized
{
    ...
    public required EventStreamCloudEventConnectionDeletedCloudEventTypeEnum Type { get; set; }
    ...
    public required EventStreamCloudEventConnectionDeletedData Data { get; set; }
