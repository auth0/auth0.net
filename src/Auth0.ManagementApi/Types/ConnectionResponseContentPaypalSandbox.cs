...
/// </summary>
[Serializable]
public record ConnectionResponseContentPaypalSandbox : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required ConnectionResponseContentPaypalSandboxStrategy Strategy { get; set; }
