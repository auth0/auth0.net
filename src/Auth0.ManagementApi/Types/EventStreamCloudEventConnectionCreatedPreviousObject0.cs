...
[Serializable]
public record EventStreamCloudEventConnectionCreatedPreviousObject0 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionCreatedPreviousObject0Authentication? Authentication { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedPreviousObject0Metadata? Metadata { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedPreviousObject0ConnectedAccounts? ConnectedAccounts { get; set; }

    [Optional]
    [JsonPropertyName("options")]
    public EventStreamCloudEventConnectionCreatedPreviousObject0Options? Options { get; set; }
    ...
    public required EventStreamCloudEventConnectionCreatedPreviousObject0StrategyEnum Strategy { get; set; }
