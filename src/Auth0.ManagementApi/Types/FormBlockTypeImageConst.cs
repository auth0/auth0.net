...
[JsonConverter(typeof(FormBlockTypeImageConst.FormBlockTypeImageConstSerializer))]
[Serializable]
public readonly record struct FormBlockTypeImageConst : IStringEnum
{
    ...
    internal class FormBlockTypeImageConstSerializer : JsonConverter<FormBlockTypeImageConst>
    {
        public override FormBlockTypeImageConst Read(
        ...
        )
        {
            ...
            return new FormBlockTypeImageConst(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            FormBlockTypeImageConst value,
            JsonSerializerOptions options
        )
        {
        ...
        public override FormBlockTypeImageConst ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
