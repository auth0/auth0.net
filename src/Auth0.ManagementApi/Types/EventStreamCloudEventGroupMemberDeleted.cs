...
/// </summary>
[Serializable]
public record EventStreamCloudEventGroupMemberDeleted : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventGroupMemberDeletedCloudEvent Event { get; set; }
