...
/// </summary>
[Serializable]
public record EventStreamCloudEventOrgConnectionAdded : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventOrgConnectionAddedCloudEvent Event { get; set; }
