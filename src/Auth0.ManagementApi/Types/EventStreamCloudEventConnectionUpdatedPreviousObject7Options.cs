...
/// </summary>
[Serializable]
public record EventStreamCloudEventConnectionUpdatedPreviousObject7Options : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject7OptionsFederatedConnectionsAccessTokens? FederatedConnectionsAccessTokens { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject7OptionsIdentityApiEnum? IdentityApi { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject7OptionsSetUserRootAttributesEnum? SetUserRootAttributes { get; set; }

    [Optional]
    [JsonPropertyName("should_trust_email_verified_connection")]
    public EventStreamCloudEventConnectionUpdatedPreviousObject7OptionsShouldTrustEmailVerifiedConnectionEnum? ShouldTrustEmailVerifiedConnection { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject7OptionsUseridAttributeEnum? UseridAttribute { get; set; }

    [Optional]
    [JsonPropertyName("waad_protocol")]
    public EventStreamCloudEventConnectionUpdatedPreviousObject7OptionsWaadProtocolEnum? WaadProtocol { get; set; }
