...
[Serializable]
public record EventStreamCloudEventConnectionCreatedPreviousObject6 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionCreatedPreviousObject6Authentication? Authentication { get; set; }

    [Optional]
    [JsonPropertyName("connected_accounts")]
    public EventStreamCloudEventConnectionCreatedPreviousObject6ConnectedAccounts? ConnectedAccounts { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedPreviousObject6Metadata? Metadata { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedPreviousObject6Options? Options { get; set; }
    ...
    public required EventStreamCloudEventConnectionCreatedPreviousObject6StrategyEnum Strategy { get; set; }
