...
[Serializable]
public record EventStreamCloudEventConnectionDeletedObject4 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionDeletedObject4Authentication? Authentication { get; set; }

    [Optional]
    [JsonPropertyName("connected_accounts")]
    public EventStreamCloudEventConnectionDeletedObject4ConnectedAccounts? ConnectedAccounts { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedObject4Metadata? Metadata { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedObject4Options? Options { get; set; }
    ...
    public required EventStreamCloudEventConnectionDeletedObject4StrategyEnum Strategy { get; set; }
