...
/// </summary>
[Serializable]
public record EventStreamCloudEventOrgMemberAddedCloudEvent : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventOrgMemberAddedCloudEventTypeEnum Type { get; set; }
    ...
    public required EventStreamCloudEventOrgMemberAddedData Data { get; set; }
