...
/// </summary>
[Serializable]
public record EventStreamCloudEventGroupCreatedObject1 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventGroupCreatedObject1TypeEnum Type { get; set; }
