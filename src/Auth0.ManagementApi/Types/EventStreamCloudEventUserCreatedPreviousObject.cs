...
/// </summary>
[Serializable]
public record EventStreamCloudEventUserCreatedPreviousObject
    : IJsonOnDeserialized,
        IJsonOnSerializing
{
    [JsonExtensionData]
    ...
    public IEnumerable<EventStreamCloudEventUserCreatedPreviousObjectIdentitiesItem> Identities { get; set; } =
        new List<EventStreamCloudEventUserCreatedPreviousObjectIdentitiesItem>();
