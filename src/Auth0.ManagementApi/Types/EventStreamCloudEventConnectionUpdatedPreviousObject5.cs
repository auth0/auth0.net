...
[Serializable]
public record EventStreamCloudEventConnectionUpdatedPreviousObject5 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject5Authentication? Authentication { get; set; }

    [Optional]
    [JsonPropertyName("connected_accounts")]
    public EventStreamCloudEventConnectionUpdatedPreviousObject5ConnectedAccounts? ConnectedAccounts { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject5Metadata? Metadata { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject5Options? Options { get; set; }

    [JsonPropertyName("strategy")]
    public required EventStreamCloudEventConnectionUpdatedPreviousObject5StrategyEnum Strategy { get; set; }
