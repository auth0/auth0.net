...
/// </summary>
[Serializable]
public record EventStreamCloudEventOrgCreatedPreviousObject : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventOrgCreatedPreviousObjectBranding? Branding { get; set; }
