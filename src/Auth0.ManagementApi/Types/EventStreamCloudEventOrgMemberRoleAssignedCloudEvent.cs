...
/// </summary>
[Serializable]
public record EventStreamCloudEventOrgMemberRoleAssignedCloudEvent : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventOrgMemberRoleAssignedCloudEventTypeEnum Type { get; set; }
    ...
    public required EventStreamCloudEventOrgMemberRoleAssignedData Data { get; set; }
