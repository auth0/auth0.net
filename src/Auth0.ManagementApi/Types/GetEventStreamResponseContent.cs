...
[JsonConverter(typeof(GetEventStreamResponseContent.JsonConverter))]
[Serializable]
public class GetEventStreamResponseContent
{
    private GetEventStreamResponseContent(string type, object? value)
    {
        Type = type;
        Value = value;
    }
    ...
    /// </summary>
    public static GetEventStreamResponseContent FromEventStreamWebhookResponseContent(
    ...
    /// </summary>
    public static GetEventStreamResponseContent FromEventStreamEventBridgeResponseContent(
    ...
    /// </summary>
    public static GetEventStreamResponseContent FromEventStreamActionResponseContent(
    ...
    public void Visit(
        global::System.Action<Auth0.ManagementApi.EventStreamWebhookResponseContent> onEventStreamWebhookResponseContent,
        global::System.Action<Auth0.ManagementApi.EventStreamEventBridgeResponseContent> onEventStreamEventBridgeResponseContent,
        global::System.Action<Auth0.ManagementApi.EventStreamActionResponseContent> onEventStreamActionResponseContent
    )
    {
        switch (Type)
        {
    ...
    public override bool Equals(object? obj)
    {
        ...
        if (ReferenceEquals(this, obj))
            return true;
        if (obj is not GetEventStreamResponseContent other)
            return false;
    ...
    public static implicit operator GetEventStreamResponseContent(
        Auth0.ManagementApi.EventStreamWebhookResponseContent value
    ) => new("eventStreamWebhookResponseContent", value);
    ...
    [Serializable]
    internal sealed class JsonConverter : JsonConverter<GetEventStreamResponseContent>
    {
        public override GetEventStreamResponseContent? Read(
        ...
        )
        {
            ...
            if (reader.TokenType == JsonTokenType.StartObject)
            {
                ...
                foreach (var (key, type) in types)
                {
                    try
                    {
                        ...
                        if (value != null)
                        {
                            GetEventStreamResponseContent result = new(key, value);
                            return result;
                        }
                    }
                    catch (JsonException)
            ...
            throw new JsonException(
                $"Cannot deserialize JSON token {reader.TokenType} into GetEventStreamResponseContent"
            );
        }

        public override void Write(
            Utf8JsonWriter writer,
            GetEventStreamResponseContent value,
            JsonSerializerOptions options
        )
        {
            if (value == null)
        ...
        public override GetEventStreamResponseContent ReadAsPropertyName(
            ref Utf8JsonReader reader,
            global::System.Type typeToConvert,
            JsonSerializerOptions options
        )
        {
            ...
            GetEventStreamResponseContent result = new("string", stringValue);
            return result;
        }
