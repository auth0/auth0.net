...
{
    private GetLogStreamResponseContent(string type, object? value)
    {
        Type = type;
        Value = value;
    }
    ...
    /// </summary>
    public static GetLogStreamResponseContent FromLogStreamHttpResponseSchema(
    ...
    /// </summary>
    public static GetLogStreamResponseContent FromLogStreamEventBridgeResponseSchema(
    ...
    /// </summary>
    public static GetLogStreamResponseContent FromLogStreamEventGridResponseSchema(
    ...
    /// </summary>
    public static GetLogStreamResponseContent FromLogStreamDatadogResponseSchema(
    ...
    /// </summary>
    public static GetLogStreamResponseContent FromLogStreamSplunkResponseSchema(
    ...
    /// </summary>
    public static GetLogStreamResponseContent FromLogStreamSumoResponseSchema(
    ...
    /// </summary>
    public static GetLogStreamResponseContent FromLogStreamSegmentResponseSchema(
    ...
    /// </summary>
    public static GetLogStreamResponseContent FromLogStreamMixpanelResponseSchema(
    ...
    public override bool Equals(object? obj)
    {
        ...
        if (ReferenceEquals(this, obj))
            return true;
        if (obj is not GetLogStreamResponseContent other)
            return false;
    ...
    public static implicit operator GetLogStreamResponseContent(
        Auth0.ManagementApi.LogStreamHttpResponseSchema value
    ) => new("logStreamHttpResponseSchema", value);
    ...
    [Serializable]
    internal sealed class JsonConverter : JsonConverter<GetLogStreamResponseContent>
    {
        public override GetLogStreamResponseContent? Read(
        ...
        )
        {
            ...
            if (reader.TokenType == JsonTokenType.StartObject)
            {
                ...
                foreach (var (key, type) in types)
                {
                    try
                    {
                        ...
                        if (value != null)
                        {
                            GetLogStreamResponseContent result = new(key, value);
                            return result;
                        }
                    }
                    catch (JsonException)
            ...
            throw new JsonException(
                $"Cannot deserialize JSON token {reader.TokenType} into GetLogStreamResponseContent"
            );
        }

        public override void Write(
            Utf8JsonWriter writer,
            GetLogStreamResponseContent value,
            JsonSerializerOptions options
        )
        {
            if (value == null)
        ...
        public override GetLogStreamResponseContent ReadAsPropertyName(
            ref Utf8JsonReader reader,
            global::System.Type typeToConvert,
            JsonSerializerOptions options
        )
        {
            ...
            GetLogStreamResponseContent result = new("string", stringValue);
            return result;
        }
