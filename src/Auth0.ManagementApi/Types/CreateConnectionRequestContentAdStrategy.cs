...
[JsonConverter(
    typeof(CreateConnectionRequestContentAdStrategy.CreateConnectionRequestContentAdStrategySerializer)
)]
[Serializable]
public readonly record struct CreateConnectionRequestContentAdStrategy : IStringEnum
{
    ...
    internal class CreateConnectionRequestContentAdStrategySerializer
        : JsonConverter<CreateConnectionRequestContentAdStrategy>
    {
        public override CreateConnectionRequestContentAdStrategy Read(
        ...
        )
        {
            ...
            return new CreateConnectionRequestContentAdStrategy(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            CreateConnectionRequestContentAdStrategy value,
            JsonSerializerOptions options
        )
        {
        ...
        public override CreateConnectionRequestContentAdStrategy ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
