...
/// </summary>
[Serializable]
public record EventStreamCloudEventUserUpdatedObject : IJsonOnDeserialized, IJsonOnSerializing
{
    [JsonExtensionData]
    ...
    public IEnumerable<EventStreamCloudEventUserUpdatedObjectIdentitiesItem> Identities { get; set; } =
        new List<EventStreamCloudEventUserUpdatedObjectIdentitiesItem>();
