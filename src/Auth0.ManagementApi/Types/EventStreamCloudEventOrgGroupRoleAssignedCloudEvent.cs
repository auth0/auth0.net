...
/// </summary>
[Serializable]
public record EventStreamCloudEventOrgGroupRoleAssignedCloudEvent : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventOrgGroupRoleAssignedCloudEventTypeEnum Type { get; set; }
    ...
    public required EventStreamCloudEventOrgGroupRoleAssignedData Data { get; set; }
