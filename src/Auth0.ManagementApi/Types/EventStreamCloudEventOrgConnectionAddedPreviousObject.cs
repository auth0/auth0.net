...
/// </summary>
[Serializable]
public record EventStreamCloudEventOrgConnectionAddedPreviousObject : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventOrgConnectionAddedPreviousObjectOrganization Organization { get; set; }

    [JsonPropertyName("connection")]
    public required EventStreamCloudEventOrgConnectionAddedPreviousObjectConnection Connection { get; set; }
    ...
    public EventStreamCloudEventOrgConnectionAddedPreviousObjectOrganizationAccessLevel? OrganizationAccessLevel { get; set; }
