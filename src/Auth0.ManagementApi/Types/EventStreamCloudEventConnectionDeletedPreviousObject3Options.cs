...
/// </summary>
[Serializable]
public record EventStreamCloudEventConnectionDeletedPreviousObject3Options : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject3OptionsAssertionDecryptionSettings? AssertionDecryptionSettings { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject3OptionsDigestAlgorithmEnum? DigestAlgorithm { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject3OptionsIdpinitiated? Idpinitiated { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject3OptionsProtocolBindingEnum? ProtocolBinding { get; set; }

    [Optional]
    [JsonPropertyName("set_user_root_attributes")]
    public EventStreamCloudEventConnectionDeletedPreviousObject3OptionsSetUserRootAttributesEnum? SetUserRootAttributes { get; set; }

    [Optional]
    [JsonPropertyName("signatureAlgorithm")]
    public EventStreamCloudEventConnectionDeletedPreviousObject3OptionsSignatureAlgorithmEnum? SignatureAlgorithm { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedPreviousObject3OptionsSubject? Subject { get; set; }
