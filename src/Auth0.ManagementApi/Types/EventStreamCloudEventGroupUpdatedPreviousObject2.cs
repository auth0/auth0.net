...
/// </summary>
[Serializable]
public record EventStreamCloudEventGroupUpdatedPreviousObject2 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventGroupUpdatedPreviousObject2TypeEnum Type { get; set; }
