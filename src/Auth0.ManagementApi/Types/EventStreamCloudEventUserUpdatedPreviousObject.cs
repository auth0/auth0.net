...
/// </summary>
[Serializable]
public record EventStreamCloudEventUserUpdatedPreviousObject
    : IJsonOnDeserialized,
        IJsonOnSerializing
{
    [JsonExtensionData]
    ...
    public IEnumerable<EventStreamCloudEventUserUpdatedPreviousObjectIdentitiesItem> Identities { get; set; } =
        new List<EventStreamCloudEventUserUpdatedPreviousObjectIdentitiesItem>();
