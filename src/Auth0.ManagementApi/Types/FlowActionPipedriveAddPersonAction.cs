...
[JsonConverter(
    typeof(FlowActionPipedriveAddPersonAction.FlowActionPipedriveAddPersonActionSerializer)
)]
[Serializable]
public readonly record struct FlowActionPipedriveAddPersonAction : IStringEnum
{
    ...
    internal class FlowActionPipedriveAddPersonActionSerializer
        : JsonConverter<FlowActionPipedriveAddPersonAction>
    {
        public override FlowActionPipedriveAddPersonAction Read(
        ...
        )
        {
            ...
            return new FlowActionPipedriveAddPersonAction(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            FlowActionPipedriveAddPersonAction value,
            JsonSerializerOptions options
        )
        {
        ...
        public override FlowActionPipedriveAddPersonAction ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
