...
[Serializable]
public record EventStreamCloudEventConnectionUpdatedPreviousObject4 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject4Authentication? Authentication { get; set; }

    [Optional]
    [JsonPropertyName("connected_accounts")]
    public EventStreamCloudEventConnectionUpdatedPreviousObject4ConnectedAccounts? ConnectedAccounts { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject4Metadata? Metadata { get; set; }
    ...
    public EventStreamCloudEventConnectionUpdatedPreviousObject4Options? Options { get; set; }
    ...
    public required EventStreamCloudEventConnectionUpdatedPreviousObject4StrategyEnum Strategy { get; set; }
