...
public class EventStreamWebhookAuthorizationResponse
{
    ...
    public void Visit(
        System.Action<Auth0.ManagementApi.EventStreamWebhookBasicAuth> onEventStreamWebhookBasicAuth,
        System.Action<Auth0.ManagementApi.EventStreamWebhookBearerAuth> onEventStreamWebhookBearerAuth
    )
    {
        switch (Type)
        {
