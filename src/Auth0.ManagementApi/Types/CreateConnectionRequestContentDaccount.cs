...
/// </summary>
[Serializable]
public record CreateConnectionRequestContentDaccount : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required CreateConnectionRequestContentDaccountStrategy Strategy { get; set; }
