...
/// </summary>
[Serializable]
public record EventStreamCloudEventConnectionDeletedObject7Options : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionDeletedObject7OptionsFederatedConnectionsAccessTokens? FederatedConnectionsAccessTokens { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedObject7OptionsIdentityApiEnum? IdentityApi { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedObject7OptionsSetUserRootAttributesEnum? SetUserRootAttributes { get; set; }

    [Optional]
    [JsonPropertyName("should_trust_email_verified_connection")]
    public EventStreamCloudEventConnectionDeletedObject7OptionsShouldTrustEmailVerifiedConnectionEnum? ShouldTrustEmailVerifiedConnection { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedObject7OptionsUseridAttributeEnum? UseridAttribute { get; set; }

    [Optional]
    [JsonPropertyName("waad_protocol")]
    public EventStreamCloudEventConnectionDeletedObject7OptionsWaadProtocolEnum? WaadProtocol { get; set; }
