...
[JsonConverter(
    typeof(CreateConnectionRequestContentYahooStrategy.CreateConnectionRequestContentYahooStrategySerializer)
)]
[Serializable]
public readonly record struct CreateConnectionRequestContentYahooStrategy : IStringEnum
{
    ...
    internal class CreateConnectionRequestContentYahooStrategySerializer
        : JsonConverter<CreateConnectionRequestContentYahooStrategy>
    {
        public override CreateConnectionRequestContentYahooStrategy Read(
        ...
        )
        {
            ...
            return new CreateConnectionRequestContentYahooStrategy(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            CreateConnectionRequestContentYahooStrategy value,
            JsonSerializerOptions options
        )
        {
        ...
        public override CreateConnectionRequestContentYahooStrategy ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
