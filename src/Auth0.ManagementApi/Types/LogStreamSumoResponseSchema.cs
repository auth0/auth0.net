...
[Serializable]
public record LogStreamSumoResponseSchema : IJsonOnDeserialized, IJsonOnSerializing
{
    [JsonExtensionData]
    ...
    public LogStreamSumoEnum? Type { get; set; }
    ...
    public LogStreamSumoSink? Sink { get; set; }
