...
/// </summary>
[Serializable]
public record EventStreamCloudEventOrgMemberRoleDeletedCloudEvent : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventOrgMemberRoleDeletedCloudEventTypeEnum Type { get; set; }
    ...
    public required EventStreamCloudEventOrgMemberRoleDeletedData Data { get; set; }
