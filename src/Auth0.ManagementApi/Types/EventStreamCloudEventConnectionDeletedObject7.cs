...
[Serializable]
public record EventStreamCloudEventConnectionDeletedObject7 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionDeletedObject7Authentication? Authentication { get; set; }

    [Optional]
    [JsonPropertyName("connected_accounts")]
    public EventStreamCloudEventConnectionDeletedObject7ConnectedAccounts? ConnectedAccounts { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedObject7Metadata? Metadata { get; set; }
    ...
    public EventStreamCloudEventConnectionDeletedObject7Options? Options { get; set; }
    ...
    public required EventStreamCloudEventConnectionDeletedObject7StrategyEnum Strategy { get; set; }
