...
/// </summary>
[Serializable]
public record EventStreamCloudEventGroupDeletedPreviousObject0 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventGroupDeletedPreviousObject0TypeEnum Type { get; set; }
