...
{
    public static readonly FlowActionHubspotGetContactAction GetContact = new(Values.GetContact);

    public FlowActionHubspotGetContactAction(string value)
    {
        Value = value;
    }
    ...
    /// </summary>
    public static FlowActionHubspotGetContactAction FromCustom(string value)
    {
        return new FlowActionHubspotGetContactAction(value);
    }
    ...
    public static bool operator ==(FlowActionHubspotGetContactAction value1, string value2) =>
        ...
        : JsonConverter<FlowActionHubspotGetContactAction>
    {
        ...
        public override FlowActionHubspotGetContactAction ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
