...
[Serializable]
public record LogStreamSegmentResponseSchema : IJsonOnDeserialized, IJsonOnSerializing
{
    [JsonExtensionData]
    ...
    public LogStreamSegmentEnum? Type { get; set; }
    ...
    public LogStreamSegmentSinkWriteKey? Sink { get; set; }
