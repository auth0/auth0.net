...
/// </summary>
[Serializable]
public record EventStreamCloudEventConnectionCreatedPreviousObject2Options : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionCreatedPreviousObject2OptionsAssertionDecryptionSettings? AssertionDecryptionSettings { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedPreviousObject2OptionsDigestAlgorithmEnum? DigestAlgorithm { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedPreviousObject2OptionsIdpinitiated? Idpinitiated { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedPreviousObject2OptionsProtocolBindingEnum? ProtocolBinding { get; set; }

    [Optional]
    [JsonPropertyName("set_user_root_attributes")]
    public EventStreamCloudEventConnectionCreatedPreviousObject2OptionsSetUserRootAttributesEnum? SetUserRootAttributes { get; set; }

    [Optional]
    [JsonPropertyName("signatureAlgorithm")]
    public EventStreamCloudEventConnectionCreatedPreviousObject2OptionsSignatureAlgorithmEnum? SignatureAlgorithm { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedPreviousObject2OptionsSubject? Subject { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedPreviousObject2OptionsOidcMetadata? OidcMetadata { get; set; }
