...
/// </summary>
[Serializable]
public record CreateConnectionRequestContentMiicard : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required CreateConnectionRequestContentMiicardStrategy Strategy { get; set; }

    [Optional]
    [JsonPropertyName("options")]
    public ConnectionOptionsMiicard? Options { get; set; }
