...
/// </summary>
[Serializable]
public record EventStreamCloudEventGroupDeletedObject1 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventGroupDeletedObject1TypeEnum Type { get; set; }
