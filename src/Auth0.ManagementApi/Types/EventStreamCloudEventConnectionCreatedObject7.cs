...
[Serializable]
public record EventStreamCloudEventConnectionCreatedObject7 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public EventStreamCloudEventConnectionCreatedObject7Authentication? Authentication { get; set; }

    [Optional]
    [JsonPropertyName("connected_accounts")]
    public EventStreamCloudEventConnectionCreatedObject7ConnectedAccounts? ConnectedAccounts { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedObject7Metadata? Metadata { get; set; }
    ...
    public EventStreamCloudEventConnectionCreatedObject7Options? Options { get; set; }
    ...
    public required EventStreamCloudEventConnectionCreatedObject7StrategyEnum Strategy { get; set; }
