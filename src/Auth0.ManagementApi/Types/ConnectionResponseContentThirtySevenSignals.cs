...
/// </summary>
[Serializable]
public record ConnectionResponseContentThirtySevenSignals : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required ConnectionResponseContentThirtySevenSignalsStrategy Strategy { get; set; }
