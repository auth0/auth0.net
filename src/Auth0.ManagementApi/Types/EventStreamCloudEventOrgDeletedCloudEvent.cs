...
/// </summary>
[Serializable]
public record EventStreamCloudEventOrgDeletedCloudEvent : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventOrgDeletedCloudEventTypeEnum Type { get; set; }
    ...
    public required EventStreamCloudEventOrgDeletedData Data { get; set; }
