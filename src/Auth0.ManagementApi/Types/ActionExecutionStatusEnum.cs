...
public readonly record struct ActionExecutionStatusEnum : IStringEnum
{
    ...
    internal class ActionExecutionStatusEnumSerializer : JsonConverter<ActionExecutionStatusEnum>
    {
        public override ActionExecutionStatusEnum Read(
        ...
        )
        {
            ...
            return new ActionExecutionStatusEnum(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            ActionExecutionStatusEnum value,
            JsonSerializerOptions options
        )
        {
        ...
        public override ActionExecutionStatusEnum ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
