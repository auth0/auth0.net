...
/// </summary>
[Serializable]
public record ConnectionResponseContentGoogleOAuth2 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required ConnectionResponseContentGoogleOAuth2Strategy Strategy { get; set; }

    [Optional]
    [JsonPropertyName("options")]
    public ConnectionOptionsGoogleOAuth2? Options { get; set; }
