...
[JsonConverter(typeof(UserDateSchema.JsonConverter))]
[Serializable]
public class UserDateSchema
{
    private UserDateSchema(string type, object? value)
    {
        Type = type;
        Value = value;
    }
    ...
    /// </summary>
    public static UserDateSchema FromString(string value) => new("string", value);

    /// <summary>
    /// Factory method to create a union from a Dictionary<string, object?> value.
    /// </summary>
    public static UserDateSchema FromMapOfStringToUnknown(Dictionary<string, object?> value) =>
        new("map", value);
    ...
    public override bool Equals(object? obj)
    {
        ...
        if (ReferenceEquals(this, obj))
            return true;
        if (obj is not UserDateSchema other)
            return false;
    ...
    public static implicit operator UserDateSchema(string value) => new("string", value);

    [Serializable]
    internal sealed class JsonConverter : JsonConverter<UserDateSchema>
    {
        ...
        )
        {
            ...
            if (reader.TokenType == JsonTokenType.String)
            {
                ...
                UserDateSchema stringResult = new("string", stringValue);
                return stringResult;
            }
            ...
            if (reader.TokenType == JsonTokenType.StartArray)
            {
                ...
                foreach (var (key, type) in types)
                {
                    try
                    {
                        ...
                        if (value != null)
                        {
                            UserDateSchema result = new(key, value);
                            return result;
                        }
                    }
                    catch (JsonException)
            ...
            throw new JsonException(
                $"Cannot deserialize JSON token {reader.TokenType} into UserDateSchema"
            );
        }

        public override void Write(
            Utf8JsonWriter writer,
            UserDateSchema value,
            JsonSerializerOptions options
        )
        {
            if (value == null)
        ...
        {
            var stringValue = reader.GetString()!;
            UserDateSchema result = new("string", stringValue);
            return result;
        }
