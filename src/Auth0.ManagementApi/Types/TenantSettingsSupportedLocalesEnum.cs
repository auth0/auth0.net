...
[JsonConverter(
    typeof(TenantSettingsSupportedLocalesEnum.TenantSettingsSupportedLocalesEnumSerializer)
)]
[Serializable]
public readonly record struct TenantSettingsSupportedLocalesEnum : IStringEnum
{
    ...
    internal class TenantSettingsSupportedLocalesEnumSerializer
        : JsonConverter<TenantSettingsSupportedLocalesEnum>
    {
        public override TenantSettingsSupportedLocalesEnum Read(
        ...
        )
        {
            ...
            return new TenantSettingsSupportedLocalesEnum(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            TenantSettingsSupportedLocalesEnum value,
            JsonSerializerOptions options
        )
        {
        ...
        public override TenantSettingsSupportedLocalesEnum ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
