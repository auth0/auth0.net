...
/// </summary>
[Serializable]
public record CreateConnectionRequestContentPlanningCenter : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required CreateConnectionRequestContentPlanningCenterStrategy Strategy { get; set; }
