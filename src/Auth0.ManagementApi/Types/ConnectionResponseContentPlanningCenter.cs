...
/// </summary>
[Serializable]
public record ConnectionResponseContentPlanningCenter : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required ConnectionResponseContentPlanningCenterStrategy Strategy { get; set; }
