...
/// </summary>
[Serializable]
public record EventStreamCloudEventGroupUpdatedPreviousObject1 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required EventStreamCloudEventGroupUpdatedPreviousObject1TypeEnum Type { get; set; }
