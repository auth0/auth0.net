...
public partial class SessionsClient : ISessionsClient
{
    ...
    private async Task<WithRawResponse<GetSessionResponseContent>> GetAsyncCore(
        string id,
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                ...
                return new WithRawResponse<GetSessionResponseContent>()
                {
                    Data = responseData,
    ...
    private async Task<WithRawResponse<UpdateSessionResponseContent>> UpdateAsyncCore(
        string id,
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                ...
                return new WithRawResponse<UpdateSessionResponseContent>()
                {
                    Data = responseData,
                    RawResponse = new Auth0.ManagementApi.RawResponse()
                    {
    ...
    /// </code></example>
    public WithRawResponseTask<GetSessionResponseContent> GetAsync(
        string id,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<GetSessionResponseContent>(
    ...
    /// </code></example>
    public WithRawResponseTask<UpdateSessionResponseContent> UpdateAsync(
        string id,
        UpdateSessionRequestContent request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    ...
    {
        return new WithRawResponseTask<UpdateSessionResponseContent>(
    ...
    {
        return new WithRawResponseTask(RevokeAsyncCore(id, options, cancellationToken));
    }
}
